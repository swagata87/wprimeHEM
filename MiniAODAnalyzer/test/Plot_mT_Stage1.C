...
int Plot_mT_Stage1() {
  ...
  */
  ...
  mT_Stage1_Run2016BCDEF->Rebin(40);
  ...
  */
  ...
  hs->SetMaximum(10000);
  hs->SetMinimum(0.01);
  hs->GetXaxis()->SetLimits(100, 3000);
  ...
  data_by_MC->SetTitle("");
  data_by_MC->GetXaxis()->SetRangeUser(100, 3000);
  ...
  ratio_c->Write();
  ratio_c->Print("mT_Stage1_ratio.pdf");
