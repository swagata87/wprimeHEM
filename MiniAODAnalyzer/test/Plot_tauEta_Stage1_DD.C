...
int Plot_tauEta_Stage1_DD() {
  ...
  TH1D* tauEta_Stage1_DYJetsToLL_M50 = (TH1D*)file_DYJetsToLL_M50->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_DYJetsToLL_M50->Scale(wt_DYJetsToLL_M50);
  std::cout << "DYJetsToLL_M50 weighted nevt=" << tauEta_Stage1_DYJetsToLL_M50->Integral() << std::endl;
  totalMC += tauEta_Stage1_DYJetsToLL_M50->Integral();
  ...
  TH1D* tauEta_Stage1_DYJetsToLL_M5to50 = (TH1D*)file_DYJetsToLL_M5to50->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_DYJetsToLL_M5to50->Scale(wt_DYJetsToLL_M5to50);
  std::cout << "DYJetsToLL_M5to50 weighted nevt=" << tauEta_Stage1_DYJetsToLL_M5to50->Integral() << std::endl;
  totalMC += tauEta_Stage1_DYJetsToLL_M5to50->Integral() ;
  //
  TH1D* total_DY = (TH1D*)tauEta_Stage1_DYJetsToLL_M50->Clone(); 
  total_DY->Add(tauEta_Stage1_DYJetsToLL_M5to50);
  ...
  TH1D* tauEta_Stage1_TT  = (TH1D*)file_TT->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_TT->Scale(wt_TT);
  tauEta_Stage1_TT->Scale(kfact_TT);
  std::cout << "TTbar weighted nevt=" << tauEta_Stage1_TT->Integral() << std::endl;
  totalMC += tauEta_Stage1_TT->Integral();
  ...
  TH1D* tauEta_Stage1_TT_Mtt_700to1000  = (TH1D*)file_TT_Mtt_700to1000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_TT_Mtt_700to1000->Scale(wt_TT_Mtt_700to1000);
  tauEta_Stage1_TT_Mtt_700to1000->Scale(kfact_TT_Mtt_700to1000);
  std::cout << "TT_Mtt_700to1000bar weighted nevt=" << tauEta_Stage1_TT_Mtt_700to1000->Integral() << std::endl;
  totalMC += tauEta_Stage1_TT_Mtt_700to1000->Integral() ;
  ...
  TH1D* tauEta_Stage1_TT_Mtt_1000toInf  = (TH1D*)file_TT_Mtt_1000toInf->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_TT_Mtt_1000toInf->Scale(wt_TT_Mtt_1000toInf);
  tauEta_Stage1_TT_Mtt_1000toInf->Scale(kfact_TT_Mtt_1000toInf);
  std::cout << "TT_Mtt_1000toInfbar weighted nevt=" << tauEta_Stage1_TT_Mtt_1000toInf->Integral() << std::endl;
  totalMC += tauEta_Stage1_TT_Mtt_1000toInf->Integral() ;

  TH1D* total_TT = (TH1D*)tauEta_Stage1_TT->Clone(); 
  total_TT->Add(tauEta_Stage1_TT_Mtt_700to1000);
  total_TT->Add(tauEta_Stage1_TT_Mtt_1000toInf);
  ...
  TH1D* tauEta_Stage1_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //
  tauEta_Stage1_WJetsToLNu->Sumw2(kFALSE);
  tauEta_Stage1_WJetsToLNu->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**WJets** unweighted nevt=" << tauEta_Stage1_WJetsToLNu->Integral() << std::endl;
  std::cout << "wt_WJetsToLNu = " << wt_WJetsToLNu << std::endl;
  tauEta_Stage1_WJetsToLNu->Scale(wt_WJetsToLNu);
  tauEta_Stage1_WJetsToLNu->SetFillColorAlpha(kGreen-7,0.5);
  tauEta_Stage1_WJetsToLNu->SetLineColor(kGreen-7);
  tauEta_Stage1_WJetsToLNu->Rebin(40);
  std::cout << "**WJets** weighted nevt=" << tauEta_Stage1_WJetsToLNu->Integral() << std::endl;
  */
  ...
  TH1D* tauEta_Stage1_ST_tchannel_antitop  = (TH1D*)file_ST_tchannel_antitop->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_ST_tchannel_antitop->Scale(wt_ST_tchannel_antitop);
  tauEta_Stage1_ST_tchannel_antitop->Scale(kfact_ST_tchannel_antitop);
  std::cout << "ST_tchannel_antitop weighted nevt=" << tauEta_Stage1_ST_tchannel_antitop->Integral() << std::endl;
  totalMC += tauEta_Stage1_ST_tchannel_antitop->Integral();
  ...
  TH1D* tauEta_Stage1_ST_tchannel_top  = (TH1D*)file_ST_tchannel_top->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_ST_tchannel_top->Scale(wt_ST_tchannel_top);
  tauEta_Stage1_ST_tchannel_top->Scale(kfact_ST_tchannel_top);
  std::cout << "ST_tchannel_top weighted nevt=" << tauEta_Stage1_ST_tchannel_top->Integral() << std::endl;
  totalMC += tauEta_Stage1_ST_tchannel_top->Integral() ;
  ...
  TH1D* tauEta_Stage1_ST_tW_antitop  = (TH1D*)file_ST_tW_antitop->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_ST_tW_antitop->Scale(wt_ST_tW_antitop);
  tauEta_Stage1_ST_tW_antitop->Scale(kfact_ST_tW_antitop);
  std::cout << "ST_tW_antitop weighted nevt=" << tauEta_Stage1_ST_tW_antitop->Integral() << std::endl;
  totalMC += tauEta_Stage1_ST_tW_antitop->Integral();
  ...
  TH1D* tauEta_Stage1_ST_tW_top  = (TH1D*)file_ST_tW_top->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_ST_tW_top->Scale(wt_ST_tW_top);
  tauEta_Stage1_ST_tW_top->Scale(kfact_ST_tW_top);
  std::cout << "ST_tW_top weighted nevt=" << tauEta_Stage1_ST_tW_top->Integral() << std::endl;
  totalMC += tauEta_Stage1_ST_tW_top->Integral() ;

  TH1D* total_ST = (TH1D*)tauEta_Stage1_ST_tchannel_antitop->Clone(); 
  total_ST->Add(tauEta_Stage1_ST_tchannel_top);
  total_ST->Add(tauEta_Stage1_ST_tW_antitop);
  total_ST->Add(tauEta_Stage1_ST_tW_top);
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT100To200  = (TH1D*)file_WJetsToLNu_HT100To200->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                           
  //  tauEta_Stage1_WJetsToLNu_HT100To200->Sumw2(kFALSE);
  //tauEta_Stage1_WJetsToLNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT100To200->Scale(wt_WJetsToLNu_HT100To200);
  std::cout << "WJetsToLNu_HT100To200 weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT100To200->Integral() << std::endl;
  totalMC += tauEta_Stage1_WJetsToLNu_HT100To200->Integral();
  //tauEta_Stage1_WJetsToLNu_HT100To200->Scale(kfact_WJetsToLNu_HT100To200);
  //  std::cout << tauEta_Stage1_WJetsToLNu_HT100To200->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT200To400  = (TH1D*)file_WJetsToLNu_HT200To400->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauEta_Stage1_WJetsToLNu_HT200To400->Sumw2(kFALSE);
  //tauEta_Stage1_WJetsToLNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT200To400->Scale(wt_WJetsToLNu_HT200To400);
 std::cout << "WJetsToLNu_HT200To400 weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT200To400->Integral() << std::endl;
 totalMC += tauEta_Stage1_WJetsToLNu_HT200To400->Integral();
  //tauEta_Stage1_WJetsToLNu_HT200To400->Scale(kfact_WJetsToLNu_HT200To400);
  //std::cout << tauEta_Stage1_WJetsToLNu_HT200To400->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT400To600  = (TH1D*)file_WJetsToLNu_HT400To600->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauEta_Stage1_WJetsToLNu_HT400To600->Sumw2(kFALSE);
  //tauEta_Stage1_WJetsToLNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT400To600->Scale(wt_WJetsToLNu_HT400To600);
  std::cout << "WJetsToLNu_HT400To600 weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT400To600->Integral() << std::endl;
  totalMC += tauEta_Stage1_WJetsToLNu_HT400To600->Integral();
  // tauEta_Stage1_WJetsToLNu_HT400To600->Scale(kfact_WJetsToLNu_HT400To600);
  // std::cout << tauEta_Stage1_WJetsToLNu_HT400To600->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT600To800  = (TH1D*)file_WJetsToLNu_HT600To800->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                                                                                                                                                      
  //  tauEta_Stage1_WJetsToLNu_HT600To800->Sumw2(kFALSE);
  // tauEta_Stage1_WJetsToLNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT600To800->Scale(wt_WJetsToLNu_HT600To800);
  std::cout << "WJetsToLNu_HT600To800 weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT600To800->Integral() << std::endl;
  totalMC +=  tauEta_Stage1_WJetsToLNu_HT600To800->Integral();
  // tauEta_Stage1_WJetsToLNu_HT600To800->Scale(kfact_WJetsToLNu_HT600To800);
  // std::cout << tauEta_Stage1_WJetsToLNu_HT600To800->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT800To1200  = (TH1D*)file_WJetsToLNu_HT800To1200->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauEta_Stage1_WJetsToLNu_HT800To1200->Sumw2(kFALSE);
  //tauEta_Stage1_WJetsToLNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT800To1200->Scale(wt_WJetsToLNu_HT800To1200);
 std::cout << "WJetsToLNu_HT800To1200 weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT800To1200->Integral() << std::endl;
 totalMC += tauEta_Stage1_WJetsToLNu_HT800To1200->Integral();
  //tauEta_Stage1_WJetsToLNu_HT800To1200->Scale(kfact_WJetsToLNu_HT800To1200);
  // std::cout << tauEta_Stage1_WJetsToLNu_HT800To1200->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT1200To2500  = (TH1D*)file_WJetsToLNu_HT1200To2500->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauEta_Stage1_WJetsToLNu_HT1200To2500->Sumw2(kFALSE);
  //tauEta_Stage1_WJetsToLNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT1200To2500->Scale(wt_WJetsToLNu_HT1200To2500);
 std::cout << "WJetsToLNu_HT1200To2500 weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT1200To2500->Integral() << std::endl;
 totalMC += tauEta_Stage1_WJetsToLNu_HT1200To2500->Integral();
  // tauEta_Stage1_WJetsToLNu_HT1200To2500->Scale(kfact_WJetsToLNu_HT1200To2500);
  //std::cout << tauEta_Stage1_WJetsToLNu_HT1200To2500->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WJetsToLNu_HT2500ToInf  = (TH1D*)file_WJetsToLNu_HT2500ToInf->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //                                                                                                                                                      
  //tauEta_Stage1_WJetsToLNu_HT2500ToInf->Sumw2(kFALSE);
  //tauEta_Stage1_WJetsToLNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WJetsToLNu_HT2500ToInf->Scale(wt_WJetsToLNu_HT2500ToInf);
 std::cout << "WJetsToLNu_HT2500ToInf weighted nevt=" << tauEta_Stage1_WJetsToLNu_HT2500ToInf->Integral() << std::endl;
 totalMC += tauEta_Stage1_WJetsToLNu_HT2500ToInf->Integral();
  //tauEta_Stage1_WJetsToLNu_HT2500ToInf->Scale(kfact_WJetsToLNu_HT2500ToInf);
  ///std::cout << tauEta_Stage1_WJetsToLNu_HT2500ToInf->GetBinError(300) << std::endl;
  ...
  TH1D* tauEta_Stage1_WToTauNu_M100  = (TH1D*)file_WToTauNu_M100->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M100->Scale(wt_WToTauNu_M100);
 std::cout << "WToTauNu_M100 weighted nevt=" << tauEta_Stage1_WToTauNu_M100->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M100->Integral() ;
  ...
  TH1D* tauEta_Stage1_WToTauNu_M200  = (TH1D*)file_WToTauNu_M200->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M200->Scale(wt_WToTauNu_M200);
 std::cout << "WToTauNu_M200 weighted nevt=" << tauEta_Stage1_WToTauNu_M200->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M200->Integral();
  ...
  TH1D* tauEta_Stage1_WToTauNu_M500  = (TH1D*)file_WToTauNu_M500->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M500->Scale(wt_WToTauNu_M500);
 std::cout << "WToTauNu_M500 weighted nevt=" << tauEta_Stage1_WToTauNu_M500->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M500->Integral() ;
  ...
  TH1D* tauEta_Stage1_WToTauNu_M1000  = (TH1D*)file_WToTauNu_M1000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M1000->Scale(wt_WToTauNu_M1000);
 std::cout << "WToTauNu_M1000 weighted nevt=" << tauEta_Stage1_WToTauNu_M1000->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M1000->Integral();
  ...
  TH1D* tauEta_Stage1_WToTauNu_M2000  = (TH1D*)file_WToTauNu_M2000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M2000->Scale(wt_WToTauNu_M2000);
 std::cout << "WToTauNu_M2000 weighted nevt=" << tauEta_Stage1_WToTauNu_M2000->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M2000->Integral();
  ...
  TH1D* tauEta_Stage1_WToTauNu_M3000  = (TH1D*)file_WToTauNu_M3000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M3000->Scale(wt_WToTauNu_M3000);
 std::cout << "WToTauNu_M3000 weighted nevt=" << tauEta_Stage1_WToTauNu_M3000->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M3000->Integral();
  ...
  TH1D* tauEta_Stage1_WToTauNu_M4000  = (TH1D*)file_WToTauNu_M4000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M4000->Scale(wt_WToTauNu_M4000);
 std::cout << "WToTauNu_M4000 weighted nevt=" << tauEta_Stage1_WToTauNu_M4000->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M4000->Integral();
  ...
  TH1D* tauEta_Stage1_WToTauNu_M5000  = (TH1D*)file_WToTauNu_M5000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M5000->Scale(wt_WToTauNu_M5000);
 std::cout << "WToTauNu_M5000 weighted nevt=" << tauEta_Stage1_WToTauNu_M5000->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M5000->Integral();
  ...
  TH1D* tauEta_Stage1_WToTauNu_M6000  = (TH1D*)file_WToTauNu_M6000->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WToTauNu_M6000->Scale(wt_WToTauNu_M6000);
 std::cout << "WToTauNu_M6000 weighted nevt=" << tauEta_Stage1_WToTauNu_M6000->Integral() << std::endl;
 totalMC += tauEta_Stage1_WToTauNu_M6000->Integral();
  ...
  TH1D* tauEta_Stage1_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/tauEta_Stage1");
  tauEta_Stage1_WJetsToLNu->Scale(wt_WJetsToLNu);
 std::cout << "WJetsToLNu weighted nevt=" << tauEta_Stage1_WJetsToLNu->Integral() << std::endl;
 totalMC += tauEta_Stage1_WJetsToLNu->Integral();

  TH1D* total_WJets = (TH1D*)tauEta_Stage1_WJetsToLNu_HT100To200->Clone();
  total_WJets->Add(tauEta_Stage1_WJetsToLNu_HT200To400);
  total_WJets->Add(tauEta_Stage1_WJetsToLNu_HT400To600);
  total_WJets->Add(tauEta_Stage1_WJetsToLNu_HT600To800);
  total_WJets->Add(tauEta_Stage1_WJetsToLNu_HT800To1200);
  total_WJets->Add(tauEta_Stage1_WJetsToLNu_HT1200To2500);
  total_WJets->Add(tauEta_Stage1_WJetsToLNu_HT2500ToInf);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M100);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M200);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M500);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M1000);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M2000);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M3000);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M4000);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M5000);
  total_WJets->Add(tauEta_Stage1_WToTauNu_M6000);
  total_WJets->Add(tauEta_Stage1_WJetsToLNu);
  ...
  TH1D* tauEta_Stage1_WW  = (TH1D*)file_WW->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //
  //tauEta_Stage1_WW->Sumw2(kFALSE);
  //tauEta_Stage1_WW->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WW->Scale(wt_WW);
 std::cout << "WW weighted nevt=" << tauEta_Stage1_WW->Integral() << std::endl;
 totalMC +=tauEta_Stage1_WW->Integral() ;
  ...
  TH1D* tauEta_Stage1_WZ  = (TH1D*)file_WZ->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //
  //tauEta_Stage1_WZ->Sumw2(kFALSE);
  // tauEta_Stage1_WZ->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_WZ->Scale(wt_WZ);
  tauEta_Stage1_WZ->Scale(kfact_WZ);
 std::cout << "WZ weighted nevt=" << tauEta_Stage1_WZ->Integral() << std::endl;
 totalMC +=  tauEta_Stage1_WZ->Integral();
  ...
  TH1D* tauEta_Stage1_ZZ  = (TH1D*)file_ZZ->Get("demo/histoDir/tauEta_Stage1");
  // Poisson error //
  //tauEta_Stage1_ZZ->Sumw2(kFALSE);
  //tauEta_Stage1_ZZ->SetBinErrorOption(TH1::kPoisson);
  tauEta_Stage1_ZZ->Scale(wt_ZZ);
  tauEta_Stage1_ZZ->Scale(kfact_ZZ);
 std::cout << "ZZ weighted nevt=" << tauEta_Stage1_ZZ->Integral() << std::endl;
 totalMC += tauEta_Stage1_ZZ->Integral();

  TH1D* total_diboson = (TH1D*)tauEta_Stage1_WW->Clone();
  total_diboson->Add(tauEta_Stage1_WZ);
  total_diboson->Add(tauEta_Stage1_ZZ);
  ...
  TH1D* total_QCD = (TH1D*)file_Datadriven->Get("demo/histoDir/tauEta_Stage1");
  total_QCD->SetFillStyle(3001);
  total_QCD->SetFillColor(kPink+1);
  total_QCD->SetLineColor(kBlack);
  total_QCD->Rebin(20);  //datadriven                                                                                                                                                                                  
  ...
  //--Data--//
   TH1D* tauEta_Stage1_Run2016F  =  (TH1D*)file_Tau_Run2016F->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016E  =  (TH1D*)file_Tau_Run2016E->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016D  =  (TH1D*)file_Tau_Run2016D->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016C  =  (TH1D*)file_Tau_Run2016C->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016B  =  (TH1D*)file_Tau_Run2016B->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016G  =  (TH1D*)file_Tau_Run2016G->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016H_v2  = (TH1D*)file_Tau_Run2016H_v2->Get("demo/histoDir/tauEta_Stage1");
   TH1D* tauEta_Stage1_Run2016H_v3  = (TH1D*)file_Tau_Run2016H_v3->Get("demo/histoDir/tauEta_Stage1");
   
   /*
  std::cout << "Will Clone B" << std::endl;
  TH1D* tauEta_Stage1_Run2016BCD = (TH1D*)tauEta_Stage1_Run2016B->Clone();
 
  std::cout << "Will add C" << std::endl;
  tauEta_Stage1_Run2016BCD->Add(tauEta_Stage1_Run2016C);

  std::cout << "Will add D" << std::endl;
  tauEta_Stage1_Run2016BCD->Add(tauEta_Stage1_Run2016D);

  //  std::cout << "Will add E" << std::endl;
  // tauEta_Stage1_Run2016BCDEF->Add(tauEta_Stage1_Run2016E);

  // std::cout << "Will add F" << std::endl;
  //  tauEta_Stage1_Run2016BCDEF->Add(tauEta_Stage1_Run2016F);
  */

  TH1D* tauEta_Stage1_Run2016all = (TH1D*)tauEta_Stage1_Run2016B->Clone();
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016C);
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016D);
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016E);
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016F);
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016G);
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016H_v2);
  tauEta_Stage1_Run2016all->Add(tauEta_Stage1_Run2016H_v3);
                                                                                                                                    
  tauEta_Stage1_Run2016all->SetMarkerStyle(20);
  tauEta_Stage1_Run2016all->SetMarkerColor(kBlack);
  tauEta_Stage1_Run2016all->SetLineColor(kBlack);
  tauEta_Stage1_Run2016all->Rebin(20);
  ...
  TH1D* tauEta_Stage1_Wprime_M4000  = (TH1D*)file_Wprime_M4000->Get("demo/histoDir/tauEta_Stage1");
  std::cout << "Sig Eff W' M4000 : " << ( tauEta_Stage1_Wprime_M4000->GetEntries() / evt_Wprime_M4000 ) << std::endl;
  tauEta_Stage1_Wprime_M4000->Scale(wt_Wprime_M4000);
  //  tauEta_Stage1_Wprime_M4000->SetFillColorAlpha(kGreen-7,0.5);
  tauEta_Stage1_Wprime_M4000->SetLineColor(kMagenta);
  tauEta_Stage1_Wprime_M4000->SetLineWidth(2);
  tauEta_Stage1_Wprime_M4000->SetLineStyle(5);
  tauEta_Stage1_Wprime_M4000->Rebin(20) ;
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("Out_tauEta_Stage1.root","RECREATE");
  outputFile->cd();

  //--//
  THStack *hs = new THStack("hs","");
  // hs->Add(tauEta_Stage1_WJetsToLNu);
  hs->Add(total_diboson);
  hs->Add(total_DY);
  hs->Add(total_ST);
  hs->Add(total_TT);
  //  hs->Add(tauEta_Stage1_DYJetsToLL_M50);
  hs->Add(total_QCD);
  //  hs->Add(total_ZJets);
  hs->Add(total_WJets);
  //tauEta_Stage1_->SetTitle("");
    /*
  ...
  */
  ...
  hs->SetMinimum(0.1);
  hs->GetXaxis()->SetRangeUser(-2.4, 2.4);
  //  hs->GetXaxis()->SetLimits(40, 3200);
  hs->GetXaxis()->SetTitle("#tau #eta");
  ...
  //  tauEta_Stage1_Run2016E->Draw("SAME E0");
  tauEta_Stage1_Run2016all->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)tauEta_Stage1_Run2016all->Clone();

  //tauEta_Stage1_Run2016C->Draw("SAME E0");
  //tauEta_Stage1_Run2016CDE->Draw("SAME E0");
  //
  tauEta_Stage1_Wprime_M4000->Draw("SAME HIST");
  //  hs->SetOption("HIST L");
  ...
  TLegend *leg_example = new TLegend(0.50,0.76,0.94,0.94);
  ...
  //leg_example->AddEntry(tauEta_Stage1_WJetsToLNu, "Wjets","f");
  ...
  leg_example->AddEntry(tauEta_Stage1_Wprime_M4000, "SSM W' 4 TeV", "l");
  leg_example->AddEntry(tauEta_Stage1_Run2016all, "Data", "pl" );
  // leg_example->AddEntry(tauEta_Stage1_Run2016E, "Data", "pl" );
  // leg_example->AddEntry(tauEta_Stage1_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("tauEta_Stage1_DD.pdf");
  ...
  */
  ...
  TH1F *data_by_MC = new TH1F("h1", "ratio", nbin, -2.4, 2.4);
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("#tau #eta");
  ...
  data_by_MC->SetTitle("");
  data_by_MC->GetXaxis()->SetRangeUser(-2.4, 2.4);
  ...
  ratio_c->Write();
  ratio_c->Print("tauEta_Stage1_ratio_DD.pdf");
