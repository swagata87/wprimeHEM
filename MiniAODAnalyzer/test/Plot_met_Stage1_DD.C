...
int Plot_met_Stage1_DD() {
  ...
  met_Stage1_WJetsToLNu->Rebin(40);
 ...
 totalMC += met_Stage1_ZZ->Integral();
  ...
  TH1D* total_QCD = (TH1D*)file_Datadriven->Get("demo/histoDir/met_Stage1");
  total_QCD->SetFillStyle(3001);
  total_QCD->SetFillColor(kPink+1);
  total_QCD->SetLineColor(kBlack);
  total_QCD->Rebin(40);  //datadriven                                                                                                                                                                                  
  ...
  */
  ...
  met_Stage1_Run2016all->Rebin(40);
  ...
  TH1D* met_Stage1_Wprime_M4000  = (TH1D*)file_Wprime_M4000->Get("demo/histoDir/met_Stage1");
  std::cout << "Sig Eff W' M4000 : " << ( met_Stage1_Wprime_M4000->GetEntries() / evt_Wprime_M4000 ) << std::endl;
  met_Stage1_Wprime_M4000->Scale(wt_Wprime_M4000);
  //  met_Stage1_Wprime_M4000->SetFillColorAlpha(kGreen-7,0.5);
  met_Stage1_Wprime_M4000->SetLineColor(kMagenta);
  met_Stage1_Wprime_M4000->SetLineWidth(2);
  met_Stage1_Wprime_M4000->SetLineStyle(5);
  met_Stage1_Wprime_M4000->Rebin(40)   ;
  ...
  */
  ...
  leg_example->AddEntry(met_Stage1_Wprime_M4000, "SSM W' 4 TeV", "l");
  leg_example->AddEntry(met_Stage1_Run2016all, "Data", "pl" );
  // leg_example->AddEntry(met_Stage1_Run2016E, "Data", "pl" );
  // leg_example->AddEntry(met_Stage1_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("met_Stage1_DD.pdf");
  ...
  */
  ...
  ratio_c->Write();
  ratio_c->Print("met_Stage1_ratio_DD.pdf");
