...
int PlotCutFlow() {
  ...
  /*
  TFile *file_ST_tchannel_antitop=new TFile("../python/crab_projects_March3/crab_ST_t-channel_antitop_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1/results/hist.root");
  double xs_ST_tchannel_antitop = 80950; //--fb--//
  double kfact_ST_tchannel_antitop = 0.326;
  //
  TFile *file_ST_tchannel_top=new TFile("../python/crab_projects_March3/crab_ST_t-channel_top_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1/results/hist.root");
  double xs_ST_tchannel_top = 103200; //--fb--//
  double kfact_ST_tchannel_top = 0.43;
  //
  TFile *file_ST_tW_antitop=new TFile("../python/crab_projects_March3/crab_ST_tW_antitop_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/results/hist.root");
  double xs_ST_tW_antitop = 38090; //--fb--//
  double kfact_ST_tW_antitop = 0.94;
  //
  TFile *file_ST_tW_top=new TFile("../python/crab_projects_March3/crab_ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/results/hist.root");
 ...
 double kfact_ZJetsToNuNu_HT600To800 =  1.23 ;
  ...
  TH1D* cutflow_Stage1_DYJetsToLL_M50 = (TH1D*)file_DYJetsToLL_M50->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_DYJetsToLL_M50->Scale(wt_DYJetsToLL_M50);
  std::cout << "DYJetsToLL_M50 weighted nevt=" << cutflow_Stage1_DYJetsToLL_M50->Integral() << std::endl;
  totalMC += cutflow_Stage1_DYJetsToLL_M50->Integral();
  ...
  TH1D* cutflow_Stage1_DYJetsToLL_M5to50 = (TH1D*)file_DYJetsToLL_M5to50->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_DYJetsToLL_M5to50->Scale(wt_DYJetsToLL_M5to50);
  std::cout << "DYJetsToLL_M5to50 weighted nevt=" << cutflow_Stage1_DYJetsToLL_M5to50->Integral() << std::endl;
  totalMC += cutflow_Stage1_DYJetsToLL_M5to50->Integral() ;
  //
  TH1D* total_DY = (TH1D*)cutflow_Stage1_DYJetsToLL_M50->Clone(); 
  total_DY->Add(cutflow_Stage1_DYJetsToLL_M5to50);
  total_DY->SetFillColorAlpha(kRed-7,0.5);
  total_DY->SetLineColor(kRed-7);
  //total_DY->Rebin(40);
  //
  ...
  TH1D* cutflow_Stage1_TT  = (TH1D*)file_TT->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_TT->Scale(wt_TT);
  cutflow_Stage1_TT->Scale(kfact_TT);
  std::cout << "TTbar weighted nevt=" << cutflow_Stage1_TT->Integral() << std::endl;
  totalMC += cutflow_Stage1_TT->Integral();
  ...
  TH1D* cutflow_Stage1_TT_Mtt_700to1000  = (TH1D*)file_TT_Mtt_700to1000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_TT_Mtt_700to1000->Scale(wt_TT_Mtt_700to1000);
  cutflow_Stage1_TT_Mtt_700to1000->Scale(kfact_TT_Mtt_700to1000);
  std::cout << "TT_Mtt_700to1000bar weighted nevt=" << cutflow_Stage1_TT_Mtt_700to1000->Integral() << std::endl;
  totalMC += cutflow_Stage1_TT_Mtt_700to1000->Integral() ;
  ...
  TH1D* cutflow_Stage1_TT_Mtt_1000toInf  = (TH1D*)file_TT_Mtt_1000toInf->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_TT_Mtt_1000toInf->Scale(wt_TT_Mtt_1000toInf);
  cutflow_Stage1_TT_Mtt_1000toInf->Scale(kfact_TT_Mtt_1000toInf);
  std::cout << "TT_Mtt_1000toInfbar weighted nevt=" << cutflow_Stage1_TT_Mtt_1000toInf->Integral() << std::endl;
  totalMC += cutflow_Stage1_TT_Mtt_1000toInf->Integral() ;

  TH1D* total_TT = (TH1D*)cutflow_Stage1_TT->Clone(); 
  total_TT->Add(cutflow_Stage1_TT_Mtt_700to1000);
  total_TT->Add(cutflow_Stage1_TT_Mtt_1000toInf);
  total_TT->SetFillColor(kBlue-7);
  total_TT->SetLineColor(kBlue-7);
  //total_TT->Rebin(40);
  ...
  TH1D* cutflow_Stage1_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  cutflow_Stage1_WJetsToLNu->Sumw2(kFALSE);
  cutflow_Stage1_WJetsToLNu->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**WJets** unweighted nevt=" << cutflow_Stage1_WJetsToLNu->Integral() << std::endl;
  std::cout << "wt_WJetsToLNu = " << wt_WJetsToLNu << std::endl;
  cutflow_Stage1_WJetsToLNu->Scale(wt_WJetsToLNu);
  cutflow_Stage1_WJetsToLNu->SetFillColorAlpha(kGreen-7,0.5);
  cutflow_Stage1_WJetsToLNu->SetLineColor(kGreen-7);
  cutflow_Stage1_WJetsToLNu->Rebin(40);
  std::cout << "**WJets** weighted nevt=" << cutflow_Stage1_WJetsToLNu->Integral() << std::endl;
  */
  ...
  TH1D* cutflow_Stage1_ST_tchannel_antitop  = (TH1D*)file_ST_tchannel_antitop->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ST_tchannel_antitop->Scale(wt_ST_tchannel_antitop);
  cutflow_Stage1_ST_tchannel_antitop->Scale(kfact_ST_tchannel_antitop);
  std::cout << "ST_tchannel_antitop weighted nevt=" << cutflow_Stage1_ST_tchannel_antitop->Integral() << std::endl;
  totalMC += cutflow_Stage1_ST_tchannel_antitop->Integral();
  ...
  TH1D* cutflow_Stage1_ST_tchannel_top  = (TH1D*)file_ST_tchannel_top->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ST_tchannel_top->Scale(wt_ST_tchannel_top);
  cutflow_Stage1_ST_tchannel_top->Scale(kfact_ST_tchannel_top);
  std::cout << "ST_tchannel_top weighted nevt=" << cutflow_Stage1_ST_tchannel_top->Integral() << std::endl;
  totalMC += cutflow_Stage1_ST_tchannel_top->Integral() ;
  ...
  TH1D* cutflow_Stage1_ST_tW_antitop  = (TH1D*)file_ST_tW_antitop->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ST_tW_antitop->Scale(wt_ST_tW_antitop);
  cutflow_Stage1_ST_tW_antitop->Scale(kfact_ST_tW_antitop);
  std::cout << "ST_tW_antitop weighted nevt=" << cutflow_Stage1_ST_tW_antitop->Integral() << std::endl;
  totalMC += cutflow_Stage1_ST_tW_antitop->Integral();
  ...
  TH1D* cutflow_Stage1_ST_tW_top  = (TH1D*)file_ST_tW_top->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ST_tW_top->Scale(wt_ST_tW_top);
  cutflow_Stage1_ST_tW_top->Scale(kfact_ST_tW_top);
  std::cout << "ST_tW_top weighted nevt=" << cutflow_Stage1_ST_tW_top->Integral() << std::endl;
  totalMC += cutflow_Stage1_ST_tW_top->Integral() ;

  TH1D* total_ST = (TH1D*)cutflow_Stage1_ST_tchannel_antitop->Clone(); 
  total_ST->Add(cutflow_Stage1_ST_tchannel_top);
  total_ST->Add(cutflow_Stage1_ST_tW_antitop);
  total_ST->Add(cutflow_Stage1_ST_tW_top);
  total_ST->SetFillColorAlpha(kCyan,0.5);
  total_ST->SetLineColor(kCyan);
  // total_ST->Rebin(40);
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT100To200  = (TH1D*)file_WJetsToLNu_HT100To200->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                           
  //  cutflow_Stage1_WJetsToLNu_HT100To200->Sumw2(kFALSE);
  //cutflow_Stage1_WJetsToLNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT100To200->Scale(wt_WJetsToLNu_HT100To200);
  std::cout << "WJetsToLNu_HT100To200 weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT100To200->Integral() << std::endl;
  totalMC += cutflow_Stage1_WJetsToLNu_HT100To200->Integral();
  //cutflow_Stage1_WJetsToLNu_HT100To200->Scale(kfact_WJetsToLNu_HT100To200);
  //  std::cout << cutflow_Stage1_WJetsToLNu_HT100To200->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT200To400  = (TH1D*)file_WJetsToLNu_HT200To400->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                                                                                                                                                      
  // cutflow_Stage1_WJetsToLNu_HT200To400->Sumw2(kFALSE);
  //cutflow_Stage1_WJetsToLNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT200To400->Scale(wt_WJetsToLNu_HT200To400);
 std::cout << "WJetsToLNu_HT200To400 weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT200To400->Integral() << std::endl;
 totalMC += cutflow_Stage1_WJetsToLNu_HT200To400->Integral();
  //cutflow_Stage1_WJetsToLNu_HT200To400->Scale(kfact_WJetsToLNu_HT200To400);
  //std::cout << cutflow_Stage1_WJetsToLNu_HT200To400->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT400To600  = (TH1D*)file_WJetsToLNu_HT400To600->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                                                                                                                                                      
  // cutflow_Stage1_WJetsToLNu_HT400To600->Sumw2(kFALSE);
  //cutflow_Stage1_WJetsToLNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT400To600->Scale(wt_WJetsToLNu_HT400To600);
  std::cout << "WJetsToLNu_HT400To600 weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT400To600->Integral() << std::endl;
  totalMC += cutflow_Stage1_WJetsToLNu_HT400To600->Integral();
  // cutflow_Stage1_WJetsToLNu_HT400To600->Scale(kfact_WJetsToLNu_HT400To600);
  // std::cout << cutflow_Stage1_WJetsToLNu_HT400To600->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT600To800  = (TH1D*)file_WJetsToLNu_HT600To800->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                                                                                                                                                      
  //  cutflow_Stage1_WJetsToLNu_HT600To800->Sumw2(kFALSE);
  // cutflow_Stage1_WJetsToLNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT600To800->Scale(wt_WJetsToLNu_HT600To800);
  std::cout << "WJetsToLNu_HT600To800 weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT600To800->Integral() << std::endl;
  totalMC +=  cutflow_Stage1_WJetsToLNu_HT600To800->Integral();
  // cutflow_Stage1_WJetsToLNu_HT600To800->Scale(kfact_WJetsToLNu_HT600To800);
  // std::cout << cutflow_Stage1_WJetsToLNu_HT600To800->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT800To1200  = (TH1D*)file_WJetsToLNu_HT800To1200->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                                                                                                                                                      
  // cutflow_Stage1_WJetsToLNu_HT800To1200->Sumw2(kFALSE);
  //cutflow_Stage1_WJetsToLNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT800To1200->Scale(wt_WJetsToLNu_HT800To1200);
 std::cout << "WJetsToLNu_HT800To1200 weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT800To1200->Integral() << std::endl;
 totalMC += cutflow_Stage1_WJetsToLNu_HT800To1200->Integral();
  //cutflow_Stage1_WJetsToLNu_HT800To1200->Scale(kfact_WJetsToLNu_HT800To1200);
  // std::cout << cutflow_Stage1_WJetsToLNu_HT800To1200->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT1200To2500  = (TH1D*)file_WJetsToLNu_HT1200To2500->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                                                                                                                                                      
  // cutflow_Stage1_WJetsToLNu_HT1200To2500->Sumw2(kFALSE);
  //cutflow_Stage1_WJetsToLNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT1200To2500->Scale(wt_WJetsToLNu_HT1200To2500);
 std::cout << "WJetsToLNu_HT1200To2500 weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT1200To2500->Integral() << std::endl;
 totalMC += cutflow_Stage1_WJetsToLNu_HT1200To2500->Integral();
  // cutflow_Stage1_WJetsToLNu_HT1200To2500->Scale(kfact_WJetsToLNu_HT1200To2500);
  //std::cout << cutflow_Stage1_WJetsToLNu_HT1200To2500->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WJetsToLNu_HT2500ToInf  = (TH1D*)file_WJetsToLNu_HT2500ToInf->Get("demo/CutFlowDir/cutflow");
  // Poisson error //                                                                                                                                                      
  //cutflow_Stage1_WJetsToLNu_HT2500ToInf->Sumw2(kFALSE);
  //cutflow_Stage1_WJetsToLNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WJetsToLNu_HT2500ToInf->Scale(wt_WJetsToLNu_HT2500ToInf);
 std::cout << "WJetsToLNu_HT2500ToInf weighted nevt=" << cutflow_Stage1_WJetsToLNu_HT2500ToInf->Integral() << std::endl;
 totalMC += cutflow_Stage1_WJetsToLNu_HT2500ToInf->Integral();
  //cutflow_Stage1_WJetsToLNu_HT2500ToInf->Scale(kfact_WJetsToLNu_HT2500ToInf);
  ///std::cout << cutflow_Stage1_WJetsToLNu_HT2500ToInf->GetBinError(300) << std::endl;
  ...
  TH1D* cutflow_Stage1_WToTauNu_M100  = (TH1D*)file_WToTauNu_M100->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M100->Scale(wt_WToTauNu_M100);
 std::cout << "WToTauNu_M100 weighted nevt=" << cutflow_Stage1_WToTauNu_M100->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M100->Integral() ;
  ...
  TH1D* cutflow_Stage1_WToTauNu_M200  = (TH1D*)file_WToTauNu_M200->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M200->Scale(wt_WToTauNu_M200);
 std::cout << "WToTauNu_M200 weighted nevt=" << cutflow_Stage1_WToTauNu_M200->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M200->Integral();
  ...
  TH1D* cutflow_Stage1_WToTauNu_M500  = (TH1D*)file_WToTauNu_M500->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M500->Scale(wt_WToTauNu_M500);
 std::cout << "WToTauNu_M500 weighted nevt=" << cutflow_Stage1_WToTauNu_M500->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M500->Integral() ;
  ...
  TH1D* cutflow_Stage1_WToTauNu_M1000  = (TH1D*)file_WToTauNu_M1000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M1000->Scale(wt_WToTauNu_M1000);
 std::cout << "WToTauNu_M1000 weighted nevt=" << cutflow_Stage1_WToTauNu_M1000->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M1000->Integral();
  ...
  TH1D* cutflow_Stage1_WToTauNu_M2000  = (TH1D*)file_WToTauNu_M2000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M2000->Scale(wt_WToTauNu_M2000);
 std::cout << "WToTauNu_M2000 weighted nevt=" << cutflow_Stage1_WToTauNu_M2000->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M2000->Integral();
  ...
  TH1D* cutflow_Stage1_WToTauNu_M3000  = (TH1D*)file_WToTauNu_M3000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M3000->Scale(wt_WToTauNu_M3000);
 std::cout << "WToTauNu_M3000 weighted nevt=" << cutflow_Stage1_WToTauNu_M3000->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M3000->Integral();
  ...
  TH1D* cutflow_Stage1_WToTauNu_M4000  = (TH1D*)file_WToTauNu_M4000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M4000->Scale(wt_WToTauNu_M4000);
 std::cout << "WToTauNu_M4000 weighted nevt=" << cutflow_Stage1_WToTauNu_M4000->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M4000->Integral();
  ...
  TH1D* cutflow_Stage1_WToTauNu_M5000  = (TH1D*)file_WToTauNu_M5000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M5000->Scale(wt_WToTauNu_M5000);
 std::cout << "WToTauNu_M5000 weighted nevt=" << cutflow_Stage1_WToTauNu_M5000->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M5000->Integral();
  ...
  TH1D* cutflow_Stage1_WToTauNu_M6000  = (TH1D*)file_WToTauNu_M6000->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WToTauNu_M6000->Scale(wt_WToTauNu_M6000);
 std::cout << "WToTauNu_M6000 weighted nevt=" << cutflow_Stage1_WToTauNu_M6000->Integral() << std::endl;
 totalMC += cutflow_Stage1_WToTauNu_M6000->Integral();
  ...
  TH1D* cutflow_Stage1_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_WJetsToLNu->Scale(wt_WJetsToLNu);
 std::cout << "WJetsToLNu weighted nevt=" << cutflow_Stage1_WJetsToLNu->Integral() << std::endl;
 totalMC += cutflow_Stage1_WJetsToLNu->Integral();

  TH1D* total_WJets = (TH1D*)cutflow_Stage1_WJetsToLNu_HT100To200->Clone();
  total_WJets->Add(cutflow_Stage1_WJetsToLNu_HT200To400);
  total_WJets->Add(cutflow_Stage1_WJetsToLNu_HT400To600);
  total_WJets->Add(cutflow_Stage1_WJetsToLNu_HT600To800);
  total_WJets->Add(cutflow_Stage1_WJetsToLNu_HT800To1200);
  total_WJets->Add(cutflow_Stage1_WJetsToLNu_HT1200To2500);
  total_WJets->Add(cutflow_Stage1_WJetsToLNu_HT2500ToInf);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M100);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M200);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M500);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M1000);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M2000);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M3000);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M4000);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M5000);
  total_WJets->Add(cutflow_Stage1_WToTauNu_M6000);
  total_WJets->Add(cutflow_Stage1_WJetsToLNu);
  total_WJets->SetFillColorAlpha(kGreen-8,0.5);
  total_WJets->SetLineColor(kGreen-8);
  ...
  TH1D* cutflow_Stage1_WW  = (TH1D*)file_WW->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_WW->Sumw2(kFALSE);
  //cutflow_Stage1_WW->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WW->Scale(wt_WW);
 std::cout << "WW weighted nevt=" << cutflow_Stage1_WW->Integral() << std::endl;
 totalMC +=cutflow_Stage1_WW->Integral() ;
  ...
  TH1D* cutflow_Stage1_WZ  = (TH1D*)file_WZ->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_WZ->Sumw2(kFALSE);
  // cutflow_Stage1_WZ->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_WZ->Scale(wt_WZ);
  cutflow_Stage1_WZ->Scale(kfact_WZ);
 std::cout << "WZ weighted nevt=" << cutflow_Stage1_WZ->Integral() << std::endl;
 totalMC +=  cutflow_Stage1_WZ->Integral();
  ...
  TH1D* cutflow_Stage1_ZZ  = (TH1D*)file_ZZ->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_ZZ->Sumw2(kFALSE);
  //cutflow_Stage1_ZZ->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_ZZ->Scale(wt_ZZ);
  cutflow_Stage1_ZZ->Scale(kfact_ZZ);
 std::cout << "ZZ weighted nevt=" << cutflow_Stage1_ZZ->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZZ->Integral();

  TH1D* total_diboson = (TH1D*)cutflow_Stage1_WW->Clone();
  total_diboson->Add(cutflow_Stage1_WZ);
  total_diboson->Add(cutflow_Stage1_ZZ);
  total_diboson->SetFillColorAlpha(kOrange+2,0.5);
  total_diboson->SetLineColor(kOrange+2);
  ...
  TH1D* cutflow_Stage1_QCD_HT200to300  = (TH1D*)file_QCD_HT200to300->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_QCD_HT200to300->Sumw2(kFALSE);
  //cutflow_Stage1_QCD_HT200to300->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT200to300->Scale(wt_QCD_HT200to300);
 std::cout << "QCD_HT200to300 weighted nevt=" << cutflow_Stage1_QCD_HT200to300->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT200to300->Integral();
  ...
  TH1D* cutflow_Stage1_QCD_HT300to500  = (TH1D*)file_QCD_HT300to500->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  // cutflow_Stage1_QCD_HT300to500->Sumw2(kFALSE);
  // cutflow_Stage1_QCD_HT300to500->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT300to500->Scale(wt_QCD_HT300to500);
 std::cout << "QCD_HT300to500 weighted nevt=" << cutflow_Stage1_QCD_HT300to500->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT300to500->Integral();
  ...
  TH1D* cutflow_Stage1_QCD_HT500to700  = (TH1D*)file_QCD_HT500to700->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_QCD_HT500to700->Sumw2(kFALSE);
  //cutflow_Stage1_QCD_HT500to700->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT500to700->Scale(wt_QCD_HT500to700);
 std::cout << "QCD_HT500to700 weighted nevt=" << cutflow_Stage1_QCD_HT500to700->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT500to700->Integral();
  ...
  TH1D* cutflow_Stage1_QCD_HT700to1000  = (TH1D*)file_QCD_HT700to1000->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_QCD_HT700to1000->Sumw2(kFALSE);
  //cutflow_Stage1_QCD_HT700to1000->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT700to1000->Scale(wt_QCD_HT700to1000);
 std::cout << "QCD_HT700to1000 weighted nevt=" << cutflow_Stage1_QCD_HT700to1000->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT700to1000->Integral();
  ...
  TH1D* cutflow_Stage1_QCD_HT1000to1500  = (TH1D*)file_QCD_HT1000to1500->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  // cutflow_Stage1_QCD_HT1000to1500->Sumw2(kFALSE);
  // cutflow_Stage1_QCD_HT1000to1500->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT1000to1500->Scale(wt_QCD_HT1000to1500);
 std::cout << "QCD_HT1000to1500 weighted nevt=" << cutflow_Stage1_QCD_HT1000to1500->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT1000to1500->Integral();
  ...
  TH1D* cutflow_Stage1_QCD_HT1500to2000  = (TH1D*)file_QCD_HT1500to2000->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_QCD_HT1500to2000->Sumw2(kFALSE);
  //cutflow_Stage1_QCD_HT1500to2000->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT1500to2000->Scale(wt_QCD_HT1500to2000);
 std::cout << "QCD_HT1500to2000 weighted nevt=" << cutflow_Stage1_QCD_HT1500to2000->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT1500to2000->Integral() ;
  ...
  TH1D* cutflow_Stage1_QCD_HT2000toInf  = (TH1D*)file_QCD_HT2000toInf->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  //cutflow_Stage1_QCD_HT2000toInf->Sumw2(kFALSE);
  //cutflow_Stage1_QCD_HT2000toInf->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_QCD_HT2000toInf->Scale(wt_QCD_HT2000toInf);
 std::cout << "QCD_HT2000toInf weighted nevt=" << cutflow_Stage1_QCD_HT2000toInf->Integral() << std::endl;
 totalMC += cutflow_Stage1_QCD_HT2000toInf->Integral();
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT100To200  = (TH1D*)file_ZJetsToNuNu_HT100To200->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ZJetsToNuNu_HT100To200->Scale(wt_ZJetsToNuNu_HT100To200);
  cutflow_Stage1_ZJetsToNuNu_HT100To200->Scale(kfact_ZJetsToNuNu_HT100To200);
  //std::cout << "\n" << cutflow_Stage1_ZJetsToNuNu_HT100To200->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT100To200 weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT100To200->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZJetsToNuNu_HT100To200->Integral();
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT200To400  = (TH1D*)file_ZJetsToNuNu_HT200To400->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ZJetsToNuNu_HT200To400->Scale(wt_ZJetsToNuNu_HT200To400);
  cutflow_Stage1_ZJetsToNuNu_HT200To400->Scale(kfact_ZJetsToNuNu_HT200To400);
  //std::cout << cutflow_Stage1_ZJetsToNuNu_HT200To400->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT200To400 weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT200To400->Integral() << std::endl;
 totalMC +=  cutflow_Stage1_ZJetsToNuNu_HT200To400->Integral();
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT400To600  = (TH1D*)file_ZJetsToNuNu_HT400To600->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ZJetsToNuNu_HT400To600->Scale(wt_ZJetsToNuNu_HT400To600);
  cutflow_Stage1_ZJetsToNuNu_HT400To600->Scale(kfact_ZJetsToNuNu_HT400To600);
  //  std::cout << cutflow_Stage1_ZJetsToNuNu_HT400To600->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT400To600 weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT400To600->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZJetsToNuNu_HT400To600->Integral();
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT600To800  = (TH1D*)file_ZJetsToNuNu_HT600To800->Get("demo/CutFlowDir/cutflow");
  cutflow_Stage1_ZJetsToNuNu_HT600To800->Scale(wt_ZJetsToNuNu_HT600To800);
  cutflow_Stage1_ZJetsToNuNu_HT600To800->Scale(kfact_ZJetsToNuNu_HT600To800);
  //  std::cout << cutflow_Stage1_ZJetsToNuNu_HT600To800->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT600To800 weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT600To800->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZJetsToNuNu_HT600To800->Integral() ;
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT800To1200  = (TH1D*)file_ZJetsToNuNu_HT800To1200->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  // cutflow_Stage1_ZJetsToNuNu_HT800To1200->Sumw2(kFALSE);
  //cutflow_Stage1_ZJetsToNuNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_ZJetsToNuNu_HT800To1200->Scale(wt_ZJetsToNuNu_HT800To1200);
  cutflow_Stage1_ZJetsToNuNu_HT800To1200->Scale(kfact_ZJetsToNuNu_HT800To1200);
  //std::cout << cutflow_Stage1_ZJetsToNuNu_HT800To1200->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT800To1200 weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT800To1200->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZJetsToNuNu_HT800To1200->Integral() ;
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT1200To2500  = (TH1D*)file_ZJetsToNuNu_HT1200To2500->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  // cutflow_Stage1_ZJetsToNuNu_HT1200To2500->Sumw2(kFALSE);
  // cutflow_Stage1_ZJetsToNuNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_ZJetsToNuNu_HT1200To2500->Scale(wt_ZJetsToNuNu_HT1200To2500);
  cutflow_Stage1_ZJetsToNuNu_HT1200To2500->Scale(kfact_ZJetsToNuNu_HT1200To2500);
  //std::cout << cutflow_Stage1_ZJetsToNuNu_HT1200To2500->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT1200To2500 weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT1200To2500->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZJetsToNuNu_HT1200To2500->Integral() ;
  ...
  TH1D* cutflow_Stage1_ZJetsToNuNu_HT2500ToInf  = (TH1D*)file_ZJetsToNuNu_HT2500ToInf->Get("demo/CutFlowDir/cutflow");
  // Poisson error //
  // cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->Sumw2(kFALSE);
  // cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->Scale(wt_ZJetsToNuNu_HT2500ToInf);
  cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->Scale(kfact_ZJetsToNuNu_HT2500ToInf);
  // std::cout << cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT2500ToInf weighted nevt=" << cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->Integral() << std::endl;
 totalMC += cutflow_Stage1_ZJetsToNuNu_HT2500ToInf->Integral();

  TH1D* total_QCD = (TH1D*)cutflow_Stage1_QCD_HT200to300->Clone();
  total_QCD->Add(cutflow_Stage1_QCD_HT300to500);
  total_QCD->Add(cutflow_Stage1_QCD_HT500to700);
  total_QCD->Add(cutflow_Stage1_QCD_HT700to1000);
  total_QCD->Add(cutflow_Stage1_QCD_HT1000to1500);
  total_QCD->Add(cutflow_Stage1_QCD_HT1500to2000);
  total_QCD->Add(cutflow_Stage1_QCD_HT2000toInf);
  
  //total_QCD->SetFillColorAlpha(kPink+1,0.5);
  // total_QCD->SetLineColor(kPink+1);


  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT100To200);
  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT200To400);
  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT400To600);
  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT600To800);
  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT800To1200);
  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT1200To2500);
  total_QCD->Add(cutflow_Stage1_ZJetsToNuNu_HT2500ToInf);
  total_QCD->SetFillColorAlpha(kYellow-9,0.5);
  total_QCD->SetLineColor(kYellow-9);
  ...
  //--Data--//
   TH1D* cutflow_Stage1_Run2016F  =  (TH1D*)file_Tau_Run2016F->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016E  =  (TH1D*)file_Tau_Run2016E->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016D  =  (TH1D*)file_Tau_Run2016D->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016C  =  (TH1D*)file_Tau_Run2016C->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016B  =  (TH1D*)file_Tau_Run2016B->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016G  =  (TH1D*)file_Tau_Run2016G->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016H_v2  = (TH1D*)file_Tau_Run2016H_v2->Get("demo/CutFlowDir/cutflow");
   TH1D* cutflow_Stage1_Run2016H_v3  = (TH1D*)file_Tau_Run2016H_v3->Get("demo/CutFlowDir/cutflow");
   
   /*
  std::cout << "Will Clone B" << std::endl;
  TH1D* cutflow_Stage1_Run2016BCD = (TH1D*)cutflow_Stage1_Run2016B->Clone();
 
  std::cout << "Will add C" << std::endl;
  cutflow_Stage1_Run2016BCD->Add(cutflow_Stage1_Run2016C);

  std::cout << "Will add D" << std::endl;
  cutflow_Stage1_Run2016BCD->Add(cutflow_Stage1_Run2016D);

  //  std::cout << "Will add E" << std::endl;
  // cutflow_Stage1_Run2016BCDEF->Add(cutflow_Stage1_Run2016E);

  // std::cout << "Will add F" << std::endl;
  //  cutflow_Stage1_Run2016BCDEF->Add(cutflow_Stage1_Run2016F);
  */

  TH1D* cutflow_Stage1_Run2016all = (TH1D*)cutflow_Stage1_Run2016B->Clone();
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016C);
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016D);
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016E);
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016F);
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016G);
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016H_v2);
  cutflow_Stage1_Run2016all->Add(cutflow_Stage1_Run2016H_v3);
                                                                                                                                    
  cutflow_Stage1_Run2016all->SetMarkerStyle(20);
  cutflow_Stage1_Run2016all->SetMarkerColor(kBlack);
  cutflow_Stage1_Run2016all->SetLineColor(kBlack);
  // cutflow_Stage1_Run2016all->Rebin(40);
  ...
  TH1D* cutflow_Stage1_Wprime_M4000  = (TH1D*)file_Wprime_M4000->Get("demo/CutFlowDir/cutflow");
  std::cout << "Sig Eff W' M4000 : " << ( cutflow_Stage1_Wprime_M4000->GetEntries() / evt_Wprime_M4000 ) << std::endl;
  cutflow_Stage1_Wprime_M4000->Scale(wt_Wprime_M4000);
  //  cutflow_Stage1_Wprime_M4000->SetFillColorAlpha(kGreen-7,0.5);
  cutflow_Stage1_Wprime_M4000->SetLineColor(kMagenta+2);
  cutflow_Stage1_Wprime_M4000->SetLineWidth(4);
  cutflow_Stage1_Wprime_M4000->SetLineStyle(5);
  //  cutflow_Stage1_Wprime_M4000->Rebin(40);
 


  const Int_t nx = 11;
  const char *people[nx] = {"Stage0", "Stage1", "Stage3", "Stage4", "Stage5", "Stage6", "Final"};
  for (i=1;i<=nx;i++) cutflow_Stage1_Wprime_M4000->GetXaxis()->SetBinLabel(i,people[i-1]);
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("Out_cutflow_Stage1.root","RECREATE");
  outputFile->cd();

  //--//
  THStack *hs = new THStack("hs","");
  // hs->Add(cutflow_Stage1_WJetsToLNu);
  hs->Add(total_diboson);
  hs->Add(total_DY);
  hs->Add(total_ST);
  hs->Add(total_TT);
  //  hs->Add(cutflow_Stage1_DYJetsToLL_M50);
  hs->Add(total_QCD);
  //  hs->Add(total_ZJets);
  hs->Add(total_WJets);

  //
  //cutflow_Stage1_->SetTitle("");
    /*
  ...
  */
  ...
  hs->SetMinimum(1);
  hs->GetXaxis()->SetRangeUser(0, 8);
  //  hs->GetXaxis()->SetLimits(40, 3200);
  hs->GetXaxis()->SetTitle("Cutflow");
  hs->GetYaxis()->SetTitle("Events");
  //  for (i=1;i<=nx;i++) hs->GetXaxis()->SetBinLabel(i,people[i-1]);

  TH1F* total =  (TH1F*)hs->GetStack()->Last()->Clone();
  //  std::cout << "data bins = " << mydata->GetNbinsX() << " width=" << mydata->GetBinWidth(2);
  double width1=total->GetBinWidth(2);

  TLine *l1=new TLine(width1,0,width1,1000000);
  l1->SetLineColor(12);
  l1->SetLineWidth(2);
  l1->SetLineStyle(3);
  l1->Draw("same");

  TLine *l2=new TLine(width1*2,0,width1*2,1000000);
  l2->SetLineColor(12);
  l2->SetLineWidth(2);
  l2->SetLineStyle(3);
  l2->Draw("same");

  TLine *l3=new TLine(width1*3,0,width1*3,1000000);
  l3->SetLineColor(12);
  l3->SetLineWidth(2);
  l3->SetLineStyle(3);
  l3->Draw("same");

  //  cutflow_Stage1_Run2016all->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)cutflow_Stage1_Run2016all->Clone();

  //cutflow_Stage1_Run2016C->Draw("SAME E0");
  //cutflow_Stage1_Run2016CDE->Draw("SAME E0");
  //
  cutflow_Stage1_Wprime_M4000->GetXaxis()->SetBinLabel(0,"stage0");
  cutflow_Stage1_Wprime_M4000->Draw("SAME HIST");
  //  hs->SetOption("HIST L");
  ...
  //leg_example->AddEntry(cutflow_Stage1_WJetsToLNu, "Wjets","f");
  ...
  leg_example->AddEntry(cutflow_Stage1_Wprime_M4000, "SSM W' 4 TeV", "l");
  // leg_example->AddEntry(cutflow_Stage1_Run2016all, "Data", "pl" );
  // leg_example->AddEntry(cutflow_Stage1_Run2016E, "Data", "pl" );
  // leg_example->AddEntry(cutflow_Stage1_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("cutflow_Stage1.pdf");
  ...
  */
  ...
  TH1F *data_by_MC = new TH1F("h1", "ratio", nbin, 0, 10);
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("Cutflow");
  ...
  data_by_MC->SetTitle("");
  data_by_MC->GetXaxis()->SetRangeUser(0, 8);
  ...
  ratio_c->Write();
  ratio_c->Print("cutflow_Stage1_ratio.pdf");
