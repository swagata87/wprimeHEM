...
int Reminiaodcompare_MT() {
  ...
  //--Data--//
   TH1D* mT_Stage1_Run2016F_old  =  (TH1D*)file_Tau_Run2016F_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016E_old  =  (TH1D*)file_Tau_Run2016E_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016D_old  =  (TH1D*)file_Tau_Run2016D_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016C_old  =  (TH1D*)file_Tau_Run2016C_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016B_old  =  (TH1D*)file_Tau_Run2016B_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016G_old  =  (TH1D*)file_Tau_Run2016G_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016H_v2_old  = (TH1D*)file_Tau_Run2016H_v2_old->Get("demo/histoDir/mT_Stage1");
   TH1D* mT_Stage1_Run2016H_v3_old  = (TH1D*)file_Tau_Run2016H_v3_old->Get("demo/histoDir/mT_Stage1");
   

  TH1D* mT_Stage1_Run2016all_old = (TH1D*)mT_Stage1_Run2016B_old->Clone();
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016C_old);
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016D_old);
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016E_old);
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016F_old);
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016G_old);
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016H_v2_old);
  mT_Stage1_Run2016all_old->Add(mT_Stage1_Run2016H_v3_old);
                                                                                                                                    
  mT_Stage1_Run2016all_old->SetMarkerStyle(24);
  mT_Stage1_Run2016all_old->SetMarkerColor(kBlue);
  mT_Stage1_Run2016all_old->SetLineColor(kBlue);
  mT_Stage1_Run2016all_old->Rebin(100);
  ...
  mT_Stage1_Run2016all->Draw("E0");
  mT_Stage1_Run2016all_old->Draw("SAME E0");

  mT_Stage1_Run2016all->SetMaximum(10000);
  mT_Stage1_Run2016all->SetMinimum(0.1);
  mT_Stage1_Run2016all->GetXaxis()->SetRangeUser(100, 2200);
  mT_Stage1_Run2016all->GetXaxis()->SetTitle("#tau pT [GeV]"); 
  mT_Stage1_Run2016all->GetYaxis()->SetTitle("Events");

  TH1F* mydata =  (TH1F*)mT_Stage1_Run2016all->Clone();
  TH1F* mydata_old =  (TH1F*)mT_Stage1_Run2016all_old->Clone();
  ...
  leg_example->AddEntry(mT_Stage1_Run2016all, "Re-MiniAOD Data", "pl" );
  leg_example->AddEntry(mT_Stage1_Run2016all_old, "Old Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("reminiaod_compare_tauMT.pdf");
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("MT [GeV]");
  ...
  data_by_MC->SetTitle("");
  data_by_MC->GetXaxis()->SetRangeUser(100, 2200);
