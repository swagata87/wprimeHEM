...
int Plot_VtxWithPUWt() {
 ...
 std::cout << "ZJetsToNuNu_HT2500ToInf weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->Integral() << std::endl;
  ...
  total_ZJets->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT200To400);
  total_ZJets->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT400To600);
  total_ZJets->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT600To800);
  total_ZJets->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200);
  total_ZJets->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500);
  total_ZJets->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf);
  ...
  // recoVtx_WithPUWt_Run2016E->Rebin(40);
  //
   ...
   // recoVtx_WithPUWt_Run2016D->Rebin(40);
  //
   ...
   //  recoVtx_WithPUWt_Run2016C->Rebin(40);

   //   TH1D* recoVtx_WithPUWt_Run2016B  = (TH1D*)file_Tau_Run2016B->Get("demo/histoDir/recoVtx_WithPUWt");
   // recoVtx_WithPUWt_Run2016B->SetMarkerStyle(20);
   // recoVtx_WithPUWt_Run2016B->SetMarkerColor(kBlack);
   //  recoVtx_WithPUWt_Run2016B->SetLineColor(kBlack);
   //  recoVtx_WithPUWt_Run2016B->Rebin(40);

   TH1D* recoVtx_WithPUWt_Run2016G  = (TH1D*)file_Tau_Run2016G->Get("demo/histoDir/recoVtx_WithPUWt");
   TH1D* recoVtx_WithPUWt_Run2016H  = (TH1D*)file_Tau_Run2016H->Get("demo/histoDir/recoVtx_WithPUWt");
  ...
  */
  ...
  TH1D* recoVtx_WithPUWt_Run2016GH = (TH1D*)recoVtx_WithPUWt_Run2016G->Clone();
  recoVtx_WithPUWt_Run2016GH->Add(recoVtx_WithPUWt_Run2016H);
  //  recoVtx_WithPUWt_Run2016BCDEF->Add(recoVtx_WithPUWt_Run2016D);
  //  recoVtx_WithPUWt_Run2016BCDEF->Add(recoVtx_WithPUWt_Run2016E);
  //  recoVtx_WithPUWt_Run2016BCDEF->Add(recoVtx_WithPUWt_Run2016F);
                                                                                                                                    
  recoVtx_WithPUWt_Run2016GH->SetMarkerStyle(20);
  recoVtx_WithPUWt_Run2016GH->SetMarkerColor(kBlack);
  recoVtx_WithPUWt_Run2016GH->SetLineColor(kBlack);
  // recoVtx_WithPUWt_Run2016GH->Rebin(40);
  ...
  //  recoVtx_WithPUWt_Wprime_M1000->SetFillColorAlpha(kGreen-7,0.5);
  ...
  //  recoVtx_WithPUWt_Wprime_M1000->Rebin(40);
  ...
  */
  ...
  recoVtx_WithPUWt_Run2016GH->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)recoVtx_WithPUWt_Run2016GH->Clone();
  ...
  leg_example->AddEntry(recoVtx_WithPUWt_Wprime_M1000, "SSM W' 1 TeV", "l");
  leg_example->AddEntry(recoVtx_WithPUWt_Run2016GH, "Data", "pl" );
  ...
  */
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("nVtx [with PU wt]");
