...
int AllTauPtRegionD() {
  ...
  TH1D* tauPt_RegD_Stage1_DYJetsToLL_M50 = (TH1D*)file_DYJetsToLL_M50->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //  tauPt_RegD_Stage1_DYJetsToLL_M50->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_DYJetsToLL_M50->SetBinErrorOption(TH1::kPoisson);
  //  std::cout << "Selected **DY** unweighted nevt=" << tauPt_RegD_Stage1_DYJetsToLL_M50->Integral() << std::endl;
  //  std::cout << "wt_DYJetsToLL_M50 = " << wt_DYJetsToLL_M50 << std::endl;
  tauPt_RegD_Stage1_DYJetsToLL_M50->Scale(wt_DYJetsToLL_M50);
  tauPt_RegD_Stage1_DYJetsToLL_M50->SetFillColorAlpha(kRed,0.5);
  tauPt_RegD_Stage1_DYJetsToLL_M50->SetLineColor(kBlack);
  tauPt_RegD_Stage1_DYJetsToLL_M50->Rebin(2);  
  std::cout << "Selected **DY** weighted nevt=" << tauPt_RegD_Stage1_DYJetsToLL_M50->Integral() << std::endl;
  ...
  TH1D* tauPt_RegD_Stage1_TT  = (TH1D*)file_TT->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //  tauPt_RegD_Stage1_TT->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_TT->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**TTbar** unweighted nevt=" << tauPt_RegD_Stage1_TT->Integral() << std::endl;
  std::cout << "wt_TT = " << wt_TT << std::endl;
  tauPt_RegD_Stage1_TT->Scale(wt_TT);
  tauPt_RegD_Stage1_TT->SetFillColor(kBlue-7);
  tauPt_RegD_Stage1_TT->SetLineColor(kBlack);
  tauPt_RegD_Stage1_TT->Rebin(2);
  std::cout << "**TTbar** weighted nevt=" << tauPt_RegD_Stage1_TT->Integral() << std::endl;
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  tauPt_RegD_Stage1_WJetsToLNu->Sumw2(kFALSE);
  tauPt_RegD_Stage1_WJetsToLNu->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**WJets** unweighted nevt=" << tauPt_RegD_Stage1_WJetsToLNu->Integral() << std::endl;
  std::cout << "wt_WJetsToLNu = " << wt_WJetsToLNu << std::endl;
  tauPt_RegD_Stage1_WJetsToLNu->Scale(wt_WJetsToLNu);
  tauPt_RegD_Stage1_WJetsToLNu->SetFillColorAlpha(kGreen-7,0.5);
  tauPt_RegD_Stage1_WJetsToLNu->SetLineColor(kGreen-7);
  tauPt_RegD_Stage1_WJetsToLNu->Rebin(20);
  std::cout << "**WJets** weighted nevt=" << tauPt_RegD_Stage1_WJetsToLNu->Integral() << std::endl;
  */
  ...
  TH1D* tauPt_RegD_Stage1_ST_tchannel_antitop  = (TH1D*)file_ST_tchannel_antitop->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //  tauPt_RegD_Stage1_ST_tchannel_antitop->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_ST_tchannel_antitop->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ST_tchannel_antitop->Scale(wt_ST_tchannel_antitop);
  ...
  TH1D* tauPt_RegD_Stage1_ST_tchannel_top  = (TH1D*)file_ST_tchannel_top->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //  tauPt_RegD_Stage1_ST_tchannel_top->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_ST_tchannel_top->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ST_tchannel_top->Scale(wt_ST_tchannel_top);
  ...
  TH1D* tauPt_RegD_Stage1_ST_tW_antitop  = (TH1D*)file_ST_tW_antitop->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //  tauPt_RegD_Stage1_ST_tW_antitop->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_ST_tW_antitop->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ST_tW_antitop->Scale(wt_ST_tW_antitop);
  ...
  TH1D* tauPt_RegD_Stage1_ST_tW_top  = (TH1D*)file_ST_tW_top->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //  tauPt_RegD_Stage1_ST_tW_top->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_ST_tW_top->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ST_tW_top->Scale(wt_ST_tW_top);

  TH1D* total_ST = (TH1D*)tauPt_RegD_Stage1_ST_tchannel_antitop->Clone(); 
  total_ST->Add(tauPt_RegD_Stage1_ST_tchannel_top);
  total_ST->Add(tauPt_RegD_Stage1_ST_tW_antitop);
  total_ST->Add(tauPt_RegD_Stage1_ST_tW_top);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT100To200  = (TH1D*)file_WJetsToLNu_HT100To200->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                           
  //  tauPt_RegD_Stage1_WJetsToLNu_HT100To200->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WJetsToLNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT100To200->Scale(wt_WJetsToLNu_HT100To200);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT200To400  = (TH1D*)file_WJetsToLNu_HT200To400->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauPt_RegD_Stage1_WJetsToLNu_HT200To400->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WJetsToLNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT200To400->Scale(wt_WJetsToLNu_HT200To400);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT400To600  = (TH1D*)file_WJetsToLNu_HT400To600->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauPt_RegD_Stage1_WJetsToLNu_HT400To600->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WJetsToLNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT400To600->Scale(wt_WJetsToLNu_HT400To600);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT600To800  = (TH1D*)file_WJetsToLNu_HT600To800->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                                                                                                                                                      
  //  tauPt_RegD_Stage1_WJetsToLNu_HT600To800->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_WJetsToLNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT600To800->Scale(wt_WJetsToLNu_HT600To800);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT800To1200  = (TH1D*)file_WJetsToLNu_HT800To1200->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauPt_RegD_Stage1_WJetsToLNu_HT800To1200->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WJetsToLNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT800To1200->Scale(wt_WJetsToLNu_HT800To1200);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT1200To2500  = (TH1D*)file_WJetsToLNu_HT1200To2500->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                                                                                                                                                      
  // tauPt_RegD_Stage1_WJetsToLNu_HT1200To2500->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WJetsToLNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT1200To2500->Scale(wt_WJetsToLNu_HT1200To2500);
  ...
  TH1D* tauPt_RegD_Stage1_WJetsToLNu_HT2500ToInf  = (TH1D*)file_WJetsToLNu_HT2500ToInf->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //                                                                                                                                                      
  //tauPt_RegD_Stage1_WJetsToLNu_HT2500ToInf->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WJetsToLNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WJetsToLNu_HT2500ToInf->Scale(wt_WJetsToLNu_HT2500ToInf);


  TH1D* total_WJets = (TH1D*)tauPt_RegD_Stage1_WJetsToLNu_HT100To200->Clone();
  total_WJets->Add(tauPt_RegD_Stage1_WJetsToLNu_HT200To400);
  total_WJets->Add(tauPt_RegD_Stage1_WJetsToLNu_HT400To600);
  total_WJets->Add(tauPt_RegD_Stage1_WJetsToLNu_HT600To800);
  total_WJets->Add(tauPt_RegD_Stage1_WJetsToLNu_HT800To1200);
  total_WJets->Add(tauPt_RegD_Stage1_WJetsToLNu_HT1200To2500);
  total_WJets->Add(tauPt_RegD_Stage1_WJetsToLNu_HT2500ToInf);
  ...
  TH1D* tauPt_RegD_Stage1_WW  = (TH1D*)file_WW->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_WW->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_WW->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WW->Scale(wt_WW);
  ...
  TH1D* tauPt_RegD_Stage1_WZ  = (TH1D*)file_WZ->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_WZ->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_WZ->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_WZ->Scale(wt_WZ);
  ...
  TH1D* tauPt_RegD_Stage1_ZZ  = (TH1D*)file_ZZ->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_ZZ->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_ZZ->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZZ->Scale(wt_ZZ);
 
  TH1D* total_diboson = (TH1D*)tauPt_RegD_Stage1_WW->Clone();
  total_diboson->Add(tauPt_RegD_Stage1_WZ);
  total_diboson->Add(tauPt_RegD_Stage1_ZZ);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT200to300  = (TH1D*)file_QCD_HT200to300->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_QCD_HT200to300->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_QCD_HT200to300->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT200to300->Scale(wt_QCD_HT200to300);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT300to500  = (TH1D*)file_QCD_HT300to500->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_QCD_HT300to500->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_QCD_HT300to500->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT300to500->Scale(wt_QCD_HT300to500);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT500to700  = (TH1D*)file_QCD_HT500to700->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_QCD_HT500to700->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_QCD_HT500to700->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT500to700->Scale(wt_QCD_HT500to700);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT700to1000  = (TH1D*)file_QCD_HT700to1000->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_QCD_HT700to1000->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_QCD_HT700to1000->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT700to1000->Scale(wt_QCD_HT700to1000);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT1000to1500  = (TH1D*)file_QCD_HT1000to1500->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_QCD_HT1000to1500->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_QCD_HT1000to1500->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT1000to1500->Scale(wt_QCD_HT1000to1500);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT1500to2000  = (TH1D*)file_QCD_HT1500to2000->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_QCD_HT1500to2000->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_QCD_HT1500to2000->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT1500to2000->Scale(wt_QCD_HT1500to2000);
  ...
  TH1D* tauPt_RegD_Stage1_QCD_HT2000toInf  = (TH1D*)file_QCD_HT2000toInf->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_QCD_HT2000toInf->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_QCD_HT2000toInf->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_QCD_HT2000toInf->Scale(wt_QCD_HT2000toInf);

  TH1D* total_QCD = (TH1D*)tauPt_RegD_Stage1_QCD_HT200to300->Clone();
  total_QCD->Add(tauPt_RegD_Stage1_QCD_HT300to500);
  total_QCD->Add(tauPt_RegD_Stage1_QCD_HT500to700);
  total_QCD->Add(tauPt_RegD_Stage1_QCD_HT700to1000);
  total_QCD->Add(tauPt_RegD_Stage1_QCD_HT1000to1500);
  total_QCD->Add(tauPt_RegD_Stage1_QCD_HT1500to2000);
  total_QCD->Add(tauPt_RegD_Stage1_QCD_HT2000toInf);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT100To200  = (TH1D*)file_ZJetsToNuNu_HT100To200->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT100To200->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT100To200->Scale(wt_ZJetsToNuNu_HT100To200);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT200To400  = (TH1D*)file_ZJetsToNuNu_HT200To400->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_ZJetsToNuNu_HT200To400->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_ZJetsToNuNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT200To400->Scale(wt_ZJetsToNuNu_HT200To400);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT400To600  = (TH1D*)file_ZJetsToNuNu_HT400To600->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT400To600->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT400To600->Scale(wt_ZJetsToNuNu_HT400To600);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT600To800  = (TH1D*)file_ZJetsToNuNu_HT600To800->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_ZJetsToNuNu_HT600To800->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT600To800->Scale(wt_ZJetsToNuNu_HT600To800);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT800To1200  = (TH1D*)file_ZJetsToNuNu_HT800To1200->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT800To1200->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_ZJetsToNuNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT800To1200->Scale(wt_ZJetsToNuNu_HT800To1200);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT1200To2500  = (TH1D*)file_ZJetsToNuNu_HT1200To2500->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT1200To2500->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT1200To2500->Scale(wt_ZJetsToNuNu_HT1200To2500);
  ...
  TH1D* tauPt_RegD_Stage1_ZJetsToNuNu_HT2500ToInf  = (TH1D*)file_ZJetsToNuNu_HT2500ToInf->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT2500ToInf->Sumw2(kFALSE);
  // tauPt_RegD_Stage1_ZJetsToNuNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_ZJetsToNuNu_HT2500ToInf->Scale(wt_ZJetsToNuNu_HT2500ToInf);

  TH1D* total_ZJets = (TH1D*)tauPt_RegD_Stage1_ZJetsToNuNu_HT100To200->Clone();
  total_ZJets->Add(tauPt_RegD_Stage1_ZJetsToNuNu_HT200To400);
  total_ZJets->Add(tauPt_RegD_Stage1_ZJetsToNuNu_HT400To600);
  total_ZJets->Add(tauPt_RegD_Stage1_ZJetsToNuNu_HT600To800);
  total_ZJets->Add(tauPt_RegD_Stage1_ZJetsToNuNu_HT800To1200);
  total_ZJets->Add(tauPt_RegD_Stage1_ZJetsToNuNu_HT1200To2500);
  total_ZJets->Add(tauPt_RegD_Stage1_ZJetsToNuNu_HT2500ToInf);
  total_ZJets->SetFillColorAlpha(kYellow-9,0.5);
  total_ZJets->SetLineColor(kBlack);
  total_ZJets->Rebin(2);

  //--Data--//
  TH1D* tauPt_RegD_Stage1_Run2016D  = (TH1D*)file_Tau_Run2016D->Get("demo/tauPt_RegD_Stage1");
  // Poisson error //
  //tauPt_RegD_Stage1_Run2016D->Sumw2(kFALSE);
  //tauPt_RegD_Stage1_Run2016D->SetBinErrorOption(TH1::kPoisson);
  tauPt_RegD_Stage1_Run2016D->SetMarkerStyle(20);
  tauPt_RegD_Stage1_Run2016D->SetMarkerColor(kBlack);
  tauPt_RegD_Stage1_Run2016D->SetLineColor(kBlack);
  tauPt_RegD_Stage1_Run2016D->Rebin(2);
  ...
  TH1D* tauPt_RegD_Stage1_Wprime_M1000  = (TH1D*)file_Wprime_M1000->Get("demo/tauPt_RegD_Stage1");
  tauPt_RegD_Stage1_Wprime_M1000->Scale(wt_Wprime_M1000);
  //  tauPt_RegD_Stage1_Wprime_M1000->SetFillColorAlpha(kGreen-7,0.5);
  tauPt_RegD_Stage1_Wprime_M1000->SetLineColor(kMagenta);
  tauPt_RegD_Stage1_Wprime_M1000->SetLineWidth(2);
  tauPt_RegD_Stage1_Wprime_M1000->SetLineStyle(5);
  tauPt_RegD_Stage1_Wprime_M1000->Rebin(2);
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("Out_tauPt_RegD_Stage1.root","RECREATE");
  outputFile->cd();

  //--//
  THStack *hs = new THStack("hs","");
  // hs->Add(tauPt_RegD_Stage1_WJetsToLNu);
  hs->Add(total_WJets);
  hs->Add(tauPt_RegD_Stage1_TT);
  hs->Add(tauPt_RegD_Stage1_DYJetsToLL_M50);
  hs->Add(total_ST);
  hs->Add(total_diboson);
  hs->Add(total_QCD);
  hs->Add(total_ZJets);
  //tauPt_RegD_Stage1_->SetTitle("");
    /*
  ...
  */
  ...
  //my_canvas->Update();
  //my_canvas->Update();
  tauPt_RegD_Stage1_Wprime_M1000->Draw("SAME HIST");
  tauPt_RegD_Stage1_Run2016D->Draw("SAME E0");

  //  hs->SetOption("HIST L");
  TLatex* Region_text = new TLatex(0.50,0.70,"Region D");
  Region_text->SetNDC();
  ...
  leg_example->AddEntry(tauPt_RegD_Stage1_DYJetsToLL_M50, "DY","f");
  leg_example->AddEntry(tauPt_RegD_Stage1_TT, "t#bar{t}","f");
  //leg_example->AddEntry(tauPt_RegD_Stage1_WJetsToLNu, "Wjets","f");
  ...
  leg_example->AddEntry(tauPt_RegD_Stage1_Wprime_M1000, "SSM W' 1 TeV", "l");
  leg_example->AddEntry(tauPt_RegD_Stage1_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("tauPt_RegD_Stage1.pdf");
  /*
