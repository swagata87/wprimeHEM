...
int Plot_recoVtx_WithPUWt() {
 ...
 double kfact_ZJetsToNuNu_HT600To800 =  1.23 ;
  ...
  std::cout << "DYJetsToLL_M50 weighted nevt=" << recoVtx_WithPUWt_DYJetsToLL_M50->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_DYJetsToLL_M50->Integral();
  ...
  std::cout << "DYJetsToLL_M5to50 weighted nevt=" << recoVtx_WithPUWt_DYJetsToLL_M5to50->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_DYJetsToLL_M5to50->Integral() ;
  //
  TH1D* total_DY = (TH1D*)recoVtx_WithPUWt_DYJetsToLL_M50->Clone(); 
  total_DY->Add(recoVtx_WithPUWt_DYJetsToLL_M5to50);
  ...
  std::cout << "TTbar weighted nevt=" << recoVtx_WithPUWt_TT->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_TT->Integral();
  ...
  TH1D* recoVtx_WithPUWt_TT_Mtt_700to1000  = (TH1D*)file_TT_Mtt_700to1000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_TT_Mtt_700to1000->Scale(wt_TT_Mtt_700to1000);
  recoVtx_WithPUWt_TT_Mtt_700to1000->Scale(kfact_TT_Mtt_700to1000);
  std::cout << "TT_Mtt_700to1000bar weighted nevt=" << recoVtx_WithPUWt_TT_Mtt_700to1000->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_TT_Mtt_700to1000->Integral() ;
  ...
  TH1D* recoVtx_WithPUWt_TT_Mtt_1000toInf  = (TH1D*)file_TT_Mtt_1000toInf->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_TT_Mtt_1000toInf->Scale(wt_TT_Mtt_1000toInf);
  recoVtx_WithPUWt_TT_Mtt_1000toInf->Scale(kfact_TT_Mtt_1000toInf);
  std::cout << "TT_Mtt_1000toInfbar weighted nevt=" << recoVtx_WithPUWt_TT_Mtt_1000toInf->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_TT_Mtt_1000toInf->Integral() ;

  TH1D* total_TT = (TH1D*)recoVtx_WithPUWt_TT->Clone(); 
  total_TT->Add(recoVtx_WithPUWt_TT_Mtt_700to1000);
  total_TT->Add(recoVtx_WithPUWt_TT_Mtt_1000toInf);
  ...
  TH1D* recoVtx_WithPUWt_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/recoVtx_WithPUWt");
  // Poisson error //
  recoVtx_WithPUWt_WJetsToLNu->Sumw2(kFALSE);
  recoVtx_WithPUWt_WJetsToLNu->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**WJets** unweighted nevt=" << recoVtx_WithPUWt_WJetsToLNu->Integral() << std::endl;
  std::cout << "wt_WJetsToLNu = " << wt_WJetsToLNu << std::endl;
  recoVtx_WithPUWt_WJetsToLNu->Scale(wt_WJetsToLNu);
  recoVtx_WithPUWt_WJetsToLNu->SetFillColorAlpha(kGreen-7,0.5);
  recoVtx_WithPUWt_WJetsToLNu->SetLineColor(kGreen-7);
  recoVtx_WithPUWt_WJetsToLNu->Rebin(40);
  std::cout << "**WJets** weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu->Integral() << std::endl;
  */
  ...
  recoVtx_WithPUWt_ST_tchannel_antitop->Scale(kfact_ST_tchannel_antitop);
  std::cout << "ST_tchannel_antitop weighted nevt=" << recoVtx_WithPUWt_ST_tchannel_antitop->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_ST_tchannel_antitop->Integral();
  ...
  recoVtx_WithPUWt_ST_tchannel_top->Scale(kfact_ST_tchannel_top);
  std::cout << "ST_tchannel_top weighted nevt=" << recoVtx_WithPUWt_ST_tchannel_top->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_ST_tchannel_top->Integral() ;
  ...
  recoVtx_WithPUWt_ST_tW_antitop->Scale(kfact_ST_tW_antitop);
  std::cout << "ST_tW_antitop weighted nevt=" << recoVtx_WithPUWt_ST_tW_antitop->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_ST_tW_antitop->Integral();
  ...
  recoVtx_WithPUWt_ST_tW_top->Scale(kfact_ST_tW_top);
  std::cout << "ST_tW_top weighted nevt=" << recoVtx_WithPUWt_ST_tW_top->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_ST_tW_top->Integral() ;

  TH1D* total_ST = (TH1D*)recoVtx_WithPUWt_ST_tchannel_antitop->Clone(); 
  total_ST->Add(recoVtx_WithPUWt_ST_tchannel_top);
  total_ST->Add(recoVtx_WithPUWt_ST_tW_antitop);
  total_ST->Add(recoVtx_WithPUWt_ST_tW_top);
  ...
  // Poisson error //                           
  //  recoVtx_WithPUWt_WJetsToLNu_HT100To200->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WJetsToLNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT100To200->Scale(wt_WJetsToLNu_HT100To200);
  std::cout << "WJetsToLNu_HT100To200 weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT100To200->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_WJetsToLNu_HT100To200->Integral();
  //recoVtx_WithPUWt_WJetsToLNu_HT100To200->Scale(kfact_WJetsToLNu_HT100To200);
  //  std::cout << recoVtx_WithPUWt_WJetsToLNu_HT100To200->GetBinError(300) << std::endl;
  ...
  // Poisson error //                                                                                                                                                      
  // recoVtx_WithPUWt_WJetsToLNu_HT200To400->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WJetsToLNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT200To400->Scale(wt_WJetsToLNu_HT200To400);
 std::cout << "WJetsToLNu_HT200To400 weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT200To400->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WJetsToLNu_HT200To400->Integral();
  //recoVtx_WithPUWt_WJetsToLNu_HT200To400->Scale(kfact_WJetsToLNu_HT200To400);
  //std::cout << recoVtx_WithPUWt_WJetsToLNu_HT200To400->GetBinError(300) << std::endl;
  ...
  // Poisson error //                                                                                                                                                      
  // recoVtx_WithPUWt_WJetsToLNu_HT400To600->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WJetsToLNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT400To600->Scale(wt_WJetsToLNu_HT400To600);
  std::cout << "WJetsToLNu_HT400To600 weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT400To600->Integral() << std::endl;
  totalMC += recoVtx_WithPUWt_WJetsToLNu_HT400To600->Integral();
  // recoVtx_WithPUWt_WJetsToLNu_HT400To600->Scale(kfact_WJetsToLNu_HT400To600);
  // std::cout << recoVtx_WithPUWt_WJetsToLNu_HT400To600->GetBinError(300) << std::endl;
  ...
  // Poisson error //                                                                                                                                                      
  //  recoVtx_WithPUWt_WJetsToLNu_HT600To800->Sumw2(kFALSE);
  // recoVtx_WithPUWt_WJetsToLNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT600To800->Scale(wt_WJetsToLNu_HT600To800);
  std::cout << "WJetsToLNu_HT600To800 weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT600To800->Integral() << std::endl;
  totalMC +=  recoVtx_WithPUWt_WJetsToLNu_HT600To800->Integral();
  // recoVtx_WithPUWt_WJetsToLNu_HT600To800->Scale(kfact_WJetsToLNu_HT600To800);
  // std::cout << recoVtx_WithPUWt_WJetsToLNu_HT600To800->GetBinError(300) << std::endl;
  ...
  // Poisson error //                                                                                                                                                      
  // recoVtx_WithPUWt_WJetsToLNu_HT800To1200->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WJetsToLNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT800To1200->Scale(wt_WJetsToLNu_HT800To1200);
 std::cout << "WJetsToLNu_HT800To1200 weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT800To1200->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WJetsToLNu_HT800To1200->Integral();
  //recoVtx_WithPUWt_WJetsToLNu_HT800To1200->Scale(kfact_WJetsToLNu_HT800To1200);
  // std::cout << recoVtx_WithPUWt_WJetsToLNu_HT800To1200->GetBinError(300) << std::endl;
  ...
  // Poisson error //                                                                                                                                                      
  // recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->Scale(wt_WJetsToLNu_HT1200To2500);
 std::cout << "WJetsToLNu_HT1200To2500 weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->Integral();
  // recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->Scale(kfact_WJetsToLNu_HT1200To2500);
  //std::cout << recoVtx_WithPUWt_WJetsToLNu_HT1200To2500->GetBinError(300) << std::endl;
  ...
  // Poisson error //                                                                                                                                                      
  //recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->Scale(wt_WJetsToLNu_HT2500ToInf);
 std::cout << "WJetsToLNu_HT2500ToInf weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->Integral();
  //recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->Scale(kfact_WJetsToLNu_HT2500ToInf);
  ///std::cout << recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf->GetBinError(300) << std::endl;
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M100  = (TH1D*)file_WToTauNu_M100->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M100->Scale(wt_WToTauNu_M100);
 std::cout << "WToTauNu_M100 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M100->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M100->Integral() ;
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M200  = (TH1D*)file_WToTauNu_M200->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M200->Scale(wt_WToTauNu_M200);
 std::cout << "WToTauNu_M200 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M200->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M200->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M500  = (TH1D*)file_WToTauNu_M500->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M500->Scale(wt_WToTauNu_M500);
 std::cout << "WToTauNu_M500 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M500->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M500->Integral() ;
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M1000  = (TH1D*)file_WToTauNu_M1000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M1000->Scale(wt_WToTauNu_M1000);
 std::cout << "WToTauNu_M1000 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M1000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M1000->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M2000  = (TH1D*)file_WToTauNu_M2000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M2000->Scale(wt_WToTauNu_M2000);
 std::cout << "WToTauNu_M2000 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M2000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M2000->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M3000  = (TH1D*)file_WToTauNu_M3000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M3000->Scale(wt_WToTauNu_M3000);
 std::cout << "WToTauNu_M3000 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M3000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M3000->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M4000  = (TH1D*)file_WToTauNu_M4000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M4000->Scale(wt_WToTauNu_M4000);
 std::cout << "WToTauNu_M4000 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M4000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M4000->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M5000  = (TH1D*)file_WToTauNu_M5000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M5000->Scale(wt_WToTauNu_M5000);
 std::cout << "WToTauNu_M5000 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M5000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M5000->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WToTauNu_M6000  = (TH1D*)file_WToTauNu_M6000->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WToTauNu_M6000->Scale(wt_WToTauNu_M6000);
 std::cout << "WToTauNu_M6000 weighted nevt=" << recoVtx_WithPUWt_WToTauNu_M6000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WToTauNu_M6000->Integral();
  ...
  TH1D* recoVtx_WithPUWt_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/recoVtx_WithPUWt");
  recoVtx_WithPUWt_WJetsToLNu->Scale(wt_WJetsToLNu);
 std::cout << "WJetsToLNu weighted nevt=" << recoVtx_WithPUWt_WJetsToLNu->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_WJetsToLNu->Integral();

  TH1D* total_WJets = (TH1D*)recoVtx_WithPUWt_WJetsToLNu_HT100To200->Clone();
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu_HT200To400);
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu_HT400To600);
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu_HT600To800);
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu_HT800To1200);
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu_HT1200To2500);
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu_HT2500ToInf);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M100);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M200);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M500);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M1000);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M2000);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M3000);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M4000);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M5000);
  total_WJets->Add(recoVtx_WithPUWt_WToTauNu_M6000);
  total_WJets->Add(recoVtx_WithPUWt_WJetsToLNu);
  ...
  // Poisson error //
  //recoVtx_WithPUWt_WW->Sumw2(kFALSE);
  //recoVtx_WithPUWt_WW->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WW->Scale(wt_WW);
 std::cout << "WW weighted nevt=" << recoVtx_WithPUWt_WW->Integral() << std::endl;
 totalMC +=recoVtx_WithPUWt_WW->Integral() ;
  ...
  // Poisson error //
  //recoVtx_WithPUWt_WZ->Sumw2(kFALSE);
  // recoVtx_WithPUWt_WZ->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_WZ->Scale(wt_WZ);
  recoVtx_WithPUWt_WZ->Scale(kfact_WZ);
 std::cout << "WZ weighted nevt=" << recoVtx_WithPUWt_WZ->Integral() << std::endl;
 totalMC +=  recoVtx_WithPUWt_WZ->Integral();
  ...
  // Poisson error //
  //recoVtx_WithPUWt_ZZ->Sumw2(kFALSE);
  //recoVtx_WithPUWt_ZZ->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_ZZ->Scale(wt_ZZ);
  recoVtx_WithPUWt_ZZ->Scale(kfact_ZZ);
 std::cout << "ZZ weighted nevt=" << recoVtx_WithPUWt_ZZ->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZZ->Integral();

  TH1D* total_diboson = (TH1D*)recoVtx_WithPUWt_WW->Clone();
  total_diboson->Add(recoVtx_WithPUWt_WZ);
  total_diboson->Add(recoVtx_WithPUWt_ZZ);
  ...
  // Poisson error //
  //recoVtx_WithPUWt_QCD_HT200to300->Sumw2(kFALSE);
  //recoVtx_WithPUWt_QCD_HT200to300->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT200to300->Scale(wt_QCD_HT200to300);
 std::cout << "QCD_HT200to300 weighted nevt=" << recoVtx_WithPUWt_QCD_HT200to300->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT200to300->Integral();
  ...
  // Poisson error //
  // recoVtx_WithPUWt_QCD_HT300to500->Sumw2(kFALSE);
  // recoVtx_WithPUWt_QCD_HT300to500->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT300to500->Scale(wt_QCD_HT300to500);
 std::cout << "QCD_HT300to500 weighted nevt=" << recoVtx_WithPUWt_QCD_HT300to500->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT300to500->Integral();
  ...
  // Poisson error //
  //recoVtx_WithPUWt_QCD_HT500to700->Sumw2(kFALSE);
  //recoVtx_WithPUWt_QCD_HT500to700->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT500to700->Scale(wt_QCD_HT500to700);
 std::cout << "QCD_HT500to700 weighted nevt=" << recoVtx_WithPUWt_QCD_HT500to700->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT500to700->Integral();
  ...
  // Poisson error //
  //recoVtx_WithPUWt_QCD_HT700to1000->Sumw2(kFALSE);
  //recoVtx_WithPUWt_QCD_HT700to1000->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT700to1000->Scale(wt_QCD_HT700to1000);
 std::cout << "QCD_HT700to1000 weighted nevt=" << recoVtx_WithPUWt_QCD_HT700to1000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT700to1000->Integral();
  ...
  // Poisson error //
  // recoVtx_WithPUWt_QCD_HT1000to1500->Sumw2(kFALSE);
  // recoVtx_WithPUWt_QCD_HT1000to1500->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT1000to1500->Scale(wt_QCD_HT1000to1500);
 std::cout << "QCD_HT1000to1500 weighted nevt=" << recoVtx_WithPUWt_QCD_HT1000to1500->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT1000to1500->Integral();
  ...
  // Poisson error //
  //recoVtx_WithPUWt_QCD_HT1500to2000->Sumw2(kFALSE);
  //recoVtx_WithPUWt_QCD_HT1500to2000->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT1500to2000->Scale(wt_QCD_HT1500to2000);
 std::cout << "QCD_HT1500to2000 weighted nevt=" << recoVtx_WithPUWt_QCD_HT1500to2000->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT1500to2000->Integral() ;
  ...
  // Poisson error //
  //recoVtx_WithPUWt_QCD_HT2000toInf->Sumw2(kFALSE);
  //recoVtx_WithPUWt_QCD_HT2000toInf->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_QCD_HT2000toInf->Scale(wt_QCD_HT2000toInf);
 std::cout << "QCD_HT2000toInf weighted nevt=" << recoVtx_WithPUWt_QCD_HT2000toInf->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_QCD_HT2000toInf->Integral();
  ...
  //std::cout << "\n" << recoVtx_WithPUWt_ZJetsToNuNu_HT100To200->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT100To200 weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT100To200->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZJetsToNuNu_HT100To200->Integral();
  ...
  //std::cout << recoVtx_WithPUWt_ZJetsToNuNu_HT200To400->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT200To400 weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT200To400->Integral() << std::endl;
 totalMC +=  recoVtx_WithPUWt_ZJetsToNuNu_HT200To400->Integral();
  ...
  //  std::cout << recoVtx_WithPUWt_ZJetsToNuNu_HT400To600->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT400To600 weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT400To600->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZJetsToNuNu_HT400To600->Integral();
  ...
  recoVtx_WithPUWt_ZJetsToNuNu_HT600To800->Scale(kfact_ZJetsToNuNu_HT600To800);
  //  std::cout << recoVtx_WithPUWt_ZJetsToNuNu_HT600To800->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT600To800 weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT600To800->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZJetsToNuNu_HT600To800->Integral() ;
  ...
  // Poisson error //
  // recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->Sumw2(kFALSE);
  //recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->Scale(wt_ZJetsToNuNu_HT800To1200);
  recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->Scale(kfact_ZJetsToNuNu_HT800To1200);
  //std::cout << recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT800To1200 weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200->Integral() ;
  ...
  // Poisson error //
  // recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->Sumw2(kFALSE);
  // recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->Scale(wt_ZJetsToNuNu_HT1200To2500);
  recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->Scale(kfact_ZJetsToNuNu_HT1200To2500);
  //std::cout << recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT1200To2500 weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500->Integral() ;
  ...
  // Poisson error //
  // recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->Sumw2(kFALSE);
  // recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->Scale(wt_ZJetsToNuNu_HT2500ToInf);
  recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->Scale(kfact_ZJetsToNuNu_HT2500ToInf);
  // std::cout << recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT2500ToInf weighted nevt=" << recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->Integral() << std::endl;
 totalMC += recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf->Integral();

  TH1D* total_QCD = (TH1D*)recoVtx_WithPUWt_QCD_HT200to300->Clone();
  total_QCD->Add(recoVtx_WithPUWt_QCD_HT300to500);
  total_QCD->Add(recoVtx_WithPUWt_QCD_HT500to700);
  total_QCD->Add(recoVtx_WithPUWt_QCD_HT700to1000);
  total_QCD->Add(recoVtx_WithPUWt_QCD_HT1000to1500);
  total_QCD->Add(recoVtx_WithPUWt_QCD_HT1500to2000);
  total_QCD->Add(recoVtx_WithPUWt_QCD_HT2000toInf);

  //  total_QCD->SetFillColorAlpha(kPink+1,0.5);
  ///  total_QCD->SetLineColor(kBlack);
  //  total_QCD->Rebin(2);
 //  TH1D* total_ZJets = (TH1D*)recoVtx_WithPUWt_ZJetsToNuNu_HT100To200->Clone();
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT100To200);
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT200To400);
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT400To600);
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT600To800);
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT800To1200);
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT1200To2500);
  total_QCD->Add(recoVtx_WithPUWt_ZJetsToNuNu_HT2500ToInf);
  ...
  //--Data--//
   TH1D* recoVtx_WithPUWt_Run2016F  =  (TH1D*)file_Tau_Run2016F->Get("demo/histoDir/recoVtx_WithPUWt");
   ...
   TH1D* recoVtx_WithPUWt_Run2016B  =  (TH1D*)file_Tau_Run2016B->Get("demo/histoDir/recoVtx_WithPUWt");
   TH1D* recoVtx_WithPUWt_Run2016G  =  (TH1D*)file_Tau_Run2016G->Get("demo/histoDir/recoVtx_WithPUWt");
   TH1D* recoVtx_WithPUWt_Run2016H_v2  = (TH1D*)file_Tau_Run2016H_v2->Get("demo/histoDir/recoVtx_WithPUWt");
   TH1D* recoVtx_WithPUWt_Run2016H_v3  = (TH1D*)file_Tau_Run2016H_v3->Get("demo/histoDir/recoVtx_WithPUWt");
   
   /*
  std::cout << "Will Clone B" << std::endl;
  TH1D* recoVtx_WithPUWt_Run2016BCD = (TH1D*)recoVtx_WithPUWt_Run2016B->Clone();
 
  std::cout << "Will add C" << std::endl;
  recoVtx_WithPUWt_Run2016BCD->Add(recoVtx_WithPUWt_Run2016C);

  std::cout << "Will add D" << std::endl;
  recoVtx_WithPUWt_Run2016BCD->Add(recoVtx_WithPUWt_Run2016D);

  //  std::cout << "Will add E" << std::endl;
  // recoVtx_WithPUWt_Run2016BCDEF->Add(recoVtx_WithPUWt_Run2016E);

  // std::cout << "Will add F" << std::endl;
  //  recoVtx_WithPUWt_Run2016BCDEF->Add(recoVtx_WithPUWt_Run2016F);
  */

  TH1D* recoVtx_WithPUWt_Run2016all = (TH1D*)recoVtx_WithPUWt_Run2016B->Clone();
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016C);
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016D);
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016E);
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016F);
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016G);
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016H_v2);
  recoVtx_WithPUWt_Run2016all->Add(recoVtx_WithPUWt_Run2016H_v3);
                                                                                                                                    
  recoVtx_WithPUWt_Run2016all->SetMarkerStyle(20);
  recoVtx_WithPUWt_Run2016all->SetMarkerColor(kBlack);
  recoVtx_WithPUWt_Run2016all->SetLineColor(kBlack);
  recoVtx_WithPUWt_Run2016all->Rebin(2);
  ...
  TH1D* recoVtx_WithPUWt_Wprime_M4000  = (TH1D*)file_Wprime_M4000->Get("demo/histoDir/recoVtx_WithPUWt");
  std::cout << "Sig Eff W' M4000 : " << ( recoVtx_WithPUWt_Wprime_M4000->GetEntries() / evt_Wprime_M4000 ) << std::endl;
  recoVtx_WithPUWt_Wprime_M4000->Scale(wt_Wprime_M4000);
  //  recoVtx_WithPUWt_Wprime_M4000->SetFillColorAlpha(kGreen-7,0.5);
  recoVtx_WithPUWt_Wprime_M4000->SetLineColor(kMagenta);
  recoVtx_WithPUWt_Wprime_M4000->SetLineWidth(2);
  recoVtx_WithPUWt_Wprime_M4000->SetLineStyle(5);
  recoVtx_WithPUWt_Wprime_M4000->Rebin(2)  ;
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("Out_recoVtx_WithPUWt.root","RECREATE");
  outputFile->cd();
  ...
  hs->Add(total_ST);
  hs->Add(total_TT);
  //  hs->Add(recoVtx_WithPUWt_DYJetsToLL_M50);
  hs->Add(total_QCD);
  //  hs->Add(total_ZJets);
  hs->Add(total_WJets);
  //recoVtx_WithPUWt_->SetTitle("");
    /*
  ...
  */
  ...
  hs->SetMinimum(0.1);
  hs->GetXaxis()->SetRangeUser(0, 100);
  //  hs->GetXaxis()->SetLimits(40, 3200);
  hs->GetXaxis()->SetTitle("nVtx(after)");
  ...
  recoVtx_WithPUWt_Run2016all->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)recoVtx_WithPUWt_Run2016all->Clone();

  //recoVtx_WithPUWt_Run2016C->Draw("SAME E0");
  //recoVtx_WithPUWt_Run2016CDE->Draw("SAME E0");
  //
  recoVtx_WithPUWt_Wprime_M4000->Draw("SAME HIST");
  //  hs->SetOption("HIST L");
  ...
  //leg_example->AddEntry(recoVtx_WithPUWt_WJetsToLNu, "Wjets","f");
  ...
  leg_example->AddEntry(recoVtx_WithPUWt_Wprime_M4000, "SSM W' 4 TeV", "l");
  leg_example->AddEntry(recoVtx_WithPUWt_Run2016all, "Data", "pl" );
  // leg_example->AddEntry(recoVtx_WithPUWt_Run2016E, "Data", "pl" );
  // leg_example->AddEntry(recoVtx_WithPUWt_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("recoVtx_WithPUWt.pdf");
  ...
  */
  ...
  TH1F *data_by_MC = new TH1F("h1", "ratio", nbin, 0, 100);
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("nVtx(after)");
  ...
  data_by_MC->SetTitle("");
  data_by_MC->GetXaxis()->SetRangeUser(0, 100);
  ...
  ratio_c->Write();
  ratio_c->Print("recoVtx_WithPUWt_ratio.pdf");
