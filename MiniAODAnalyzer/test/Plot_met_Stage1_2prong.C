...
int Plot_met_Stage1_2prong() {
 ...
 double kfact_ZJetsToNuNu_HT600To800 =  1.23 ;
  ...
  TH1D* met_Stage1_2prong_DYJetsToLL_M50 = (TH1D*)file_DYJetsToLL_M50->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_DYJetsToLL_M50->Scale(wt_DYJetsToLL_M50);
  std::cout << "DYJetsToLL_M50 weighted nevt=" << met_Stage1_2prong_DYJetsToLL_M50->Integral() << std::endl;
  totalMC += met_Stage1_2prong_DYJetsToLL_M50->Integral();
  ...
  TH1D* met_Stage1_2prong_DYJetsToLL_M5to50 = (TH1D*)file_DYJetsToLL_M5to50->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_DYJetsToLL_M5to50->Scale(wt_DYJetsToLL_M5to50);
  std::cout << "DYJetsToLL_M5to50 weighted nevt=" << met_Stage1_2prong_DYJetsToLL_M5to50->Integral() << std::endl;
  totalMC += met_Stage1_2prong_DYJetsToLL_M5to50->Integral() ;
  //
  TH1D* total_DY = (TH1D*)met_Stage1_2prong_DYJetsToLL_M50->Clone(); 
  total_DY->Add(met_Stage1_2prong_DYJetsToLL_M5to50);
  ...
  TH1D* met_Stage1_2prong_TT  = (TH1D*)file_TT->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_TT->Scale(wt_TT);
  met_Stage1_2prong_TT->Scale(kfact_TT);
  std::cout << "TTbar weighted nevt=" << met_Stage1_2prong_TT->Integral() << std::endl;
  totalMC += met_Stage1_2prong_TT->Integral();
  ...
  TH1D* met_Stage1_2prong_TT_Mtt_700to1000  = (TH1D*)file_TT_Mtt_700to1000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_TT_Mtt_700to1000->Scale(wt_TT_Mtt_700to1000);
  met_Stage1_2prong_TT_Mtt_700to1000->Scale(kfact_TT_Mtt_700to1000);
  std::cout << "TT_Mtt_700to1000bar weighted nevt=" << met_Stage1_2prong_TT_Mtt_700to1000->Integral() << std::endl;
  totalMC += met_Stage1_2prong_TT_Mtt_700to1000->Integral() ;
  ...
  TH1D* met_Stage1_2prong_TT_Mtt_1000toInf  = (TH1D*)file_TT_Mtt_1000toInf->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_TT_Mtt_1000toInf->Scale(wt_TT_Mtt_1000toInf);
  met_Stage1_2prong_TT_Mtt_1000toInf->Scale(kfact_TT_Mtt_1000toInf);
  std::cout << "TT_Mtt_1000toInfbar weighted nevt=" << met_Stage1_2prong_TT_Mtt_1000toInf->Integral() << std::endl;
  totalMC += met_Stage1_2prong_TT_Mtt_1000toInf->Integral() ;

  TH1D* total_TT = (TH1D*)met_Stage1_2prong_TT->Clone(); 
  total_TT->Add(met_Stage1_2prong_TT_Mtt_700to1000);
  total_TT->Add(met_Stage1_2prong_TT_Mtt_1000toInf);
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  met_Stage1_2prong_WJetsToLNu->Sumw2(kFALSE);
  met_Stage1_2prong_WJetsToLNu->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**WJets** unweighted nevt=" << met_Stage1_2prong_WJetsToLNu->Integral() << std::endl;
  std::cout << "wt_WJetsToLNu = " << wt_WJetsToLNu << std::endl;
  met_Stage1_2prong_WJetsToLNu->Scale(wt_WJetsToLNu);
  met_Stage1_2prong_WJetsToLNu->SetFillColorAlpha(kGreen-7,0.5);
  met_Stage1_2prong_WJetsToLNu->SetLineColor(kGreen-7);
  met_Stage1_2prong_WJetsToLNu->Rebin(40);
  std::cout << "**WJets** weighted nevt=" << met_Stage1_2prong_WJetsToLNu->Integral() << std::endl;
  */
  ...
  TH1D* met_Stage1_2prong_ST_tchannel_antitop  = (TH1D*)file_ST_tchannel_antitop->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ST_tchannel_antitop->Scale(wt_ST_tchannel_antitop);
  met_Stage1_2prong_ST_tchannel_antitop->Scale(kfact_ST_tchannel_antitop);
  std::cout << "ST_tchannel_antitop weighted nevt=" << met_Stage1_2prong_ST_tchannel_antitop->Integral() << std::endl;
  totalMC += met_Stage1_2prong_ST_tchannel_antitop->Integral();
  ...
  TH1D* met_Stage1_2prong_ST_tchannel_top  = (TH1D*)file_ST_tchannel_top->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ST_tchannel_top->Scale(wt_ST_tchannel_top);
  met_Stage1_2prong_ST_tchannel_top->Scale(kfact_ST_tchannel_top);
  std::cout << "ST_tchannel_top weighted nevt=" << met_Stage1_2prong_ST_tchannel_top->Integral() << std::endl;
  totalMC += met_Stage1_2prong_ST_tchannel_top->Integral() ;
  ...
  TH1D* met_Stage1_2prong_ST_tW_antitop  = (TH1D*)file_ST_tW_antitop->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ST_tW_antitop->Scale(wt_ST_tW_antitop);
  met_Stage1_2prong_ST_tW_antitop->Scale(kfact_ST_tW_antitop);
  std::cout << "ST_tW_antitop weighted nevt=" << met_Stage1_2prong_ST_tW_antitop->Integral() << std::endl;
  totalMC += met_Stage1_2prong_ST_tW_antitop->Integral();
  ...
  TH1D* met_Stage1_2prong_ST_tW_top  = (TH1D*)file_ST_tW_top->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ST_tW_top->Scale(wt_ST_tW_top);
  met_Stage1_2prong_ST_tW_top->Scale(kfact_ST_tW_top);
  std::cout << "ST_tW_top weighted nevt=" << met_Stage1_2prong_ST_tW_top->Integral() << std::endl;
  totalMC += met_Stage1_2prong_ST_tW_top->Integral() ;

  TH1D* total_ST = (TH1D*)met_Stage1_2prong_ST_tchannel_antitop->Clone(); 
  total_ST->Add(met_Stage1_2prong_ST_tchannel_top);
  total_ST->Add(met_Stage1_2prong_ST_tW_antitop);
  total_ST->Add(met_Stage1_2prong_ST_tW_top);
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT100To200  = (TH1D*)file_WJetsToLNu_HT100To200->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                           
  //  met_Stage1_2prong_WJetsToLNu_HT100To200->Sumw2(kFALSE);
  //met_Stage1_2prong_WJetsToLNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT100To200->Scale(wt_WJetsToLNu_HT100To200);
  std::cout << "WJetsToLNu_HT100To200 weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT100To200->Integral() << std::endl;
  totalMC += met_Stage1_2prong_WJetsToLNu_HT100To200->Integral();
  //met_Stage1_2prong_WJetsToLNu_HT100To200->Scale(kfact_WJetsToLNu_HT100To200);
  //  std::cout << met_Stage1_2prong_WJetsToLNu_HT100To200->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT200To400  = (TH1D*)file_WJetsToLNu_HT200To400->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                                                                                                                                                      
  // met_Stage1_2prong_WJetsToLNu_HT200To400->Sumw2(kFALSE);
  //met_Stage1_2prong_WJetsToLNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT200To400->Scale(wt_WJetsToLNu_HT200To400);
 std::cout << "WJetsToLNu_HT200To400 weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT200To400->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WJetsToLNu_HT200To400->Integral();
  //met_Stage1_2prong_WJetsToLNu_HT200To400->Scale(kfact_WJetsToLNu_HT200To400);
  //std::cout << met_Stage1_2prong_WJetsToLNu_HT200To400->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT400To600  = (TH1D*)file_WJetsToLNu_HT400To600->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                                                                                                                                                      
  // met_Stage1_2prong_WJetsToLNu_HT400To600->Sumw2(kFALSE);
  //met_Stage1_2prong_WJetsToLNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT400To600->Scale(wt_WJetsToLNu_HT400To600);
  std::cout << "WJetsToLNu_HT400To600 weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT400To600->Integral() << std::endl;
  totalMC += met_Stage1_2prong_WJetsToLNu_HT400To600->Integral();
  // met_Stage1_2prong_WJetsToLNu_HT400To600->Scale(kfact_WJetsToLNu_HT400To600);
  // std::cout << met_Stage1_2prong_WJetsToLNu_HT400To600->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT600To800  = (TH1D*)file_WJetsToLNu_HT600To800->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                                                                                                                                                      
  //  met_Stage1_2prong_WJetsToLNu_HT600To800->Sumw2(kFALSE);
  // met_Stage1_2prong_WJetsToLNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT600To800->Scale(wt_WJetsToLNu_HT600To800);
  std::cout << "WJetsToLNu_HT600To800 weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT600To800->Integral() << std::endl;
  totalMC +=  met_Stage1_2prong_WJetsToLNu_HT600To800->Integral();
  // met_Stage1_2prong_WJetsToLNu_HT600To800->Scale(kfact_WJetsToLNu_HT600To800);
  // std::cout << met_Stage1_2prong_WJetsToLNu_HT600To800->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT800To1200  = (TH1D*)file_WJetsToLNu_HT800To1200->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                                                                                                                                                      
  // met_Stage1_2prong_WJetsToLNu_HT800To1200->Sumw2(kFALSE);
  //met_Stage1_2prong_WJetsToLNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT800To1200->Scale(wt_WJetsToLNu_HT800To1200);
 std::cout << "WJetsToLNu_HT800To1200 weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT800To1200->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WJetsToLNu_HT800To1200->Integral();
  //met_Stage1_2prong_WJetsToLNu_HT800To1200->Scale(kfact_WJetsToLNu_HT800To1200);
  // std::cout << met_Stage1_2prong_WJetsToLNu_HT800To1200->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT1200To2500  = (TH1D*)file_WJetsToLNu_HT1200To2500->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                                                                                                                                                      
  // met_Stage1_2prong_WJetsToLNu_HT1200To2500->Sumw2(kFALSE);
  //met_Stage1_2prong_WJetsToLNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT1200To2500->Scale(wt_WJetsToLNu_HT1200To2500);
 std::cout << "WJetsToLNu_HT1200To2500 weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT1200To2500->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WJetsToLNu_HT1200To2500->Integral();
  // met_Stage1_2prong_WJetsToLNu_HT1200To2500->Scale(kfact_WJetsToLNu_HT1200To2500);
  //std::cout << met_Stage1_2prong_WJetsToLNu_HT1200To2500->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu_HT2500ToInf  = (TH1D*)file_WJetsToLNu_HT2500ToInf->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //                                                                                                                                                      
  //met_Stage1_2prong_WJetsToLNu_HT2500ToInf->Sumw2(kFALSE);
  //met_Stage1_2prong_WJetsToLNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WJetsToLNu_HT2500ToInf->Scale(wt_WJetsToLNu_HT2500ToInf);
 std::cout << "WJetsToLNu_HT2500ToInf weighted nevt=" << met_Stage1_2prong_WJetsToLNu_HT2500ToInf->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WJetsToLNu_HT2500ToInf->Integral();
  //met_Stage1_2prong_WJetsToLNu_HT2500ToInf->Scale(kfact_WJetsToLNu_HT2500ToInf);
  ///std::cout << met_Stage1_2prong_WJetsToLNu_HT2500ToInf->GetBinError(300) << std::endl;
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M100  = (TH1D*)file_WToTauNu_M100->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M100->Scale(wt_WToTauNu_M100);
 std::cout << "WToTauNu_M100 weighted nevt=" << met_Stage1_2prong_WToTauNu_M100->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M100->Integral() ;
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M200  = (TH1D*)file_WToTauNu_M200->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M200->Scale(wt_WToTauNu_M200);
 std::cout << "WToTauNu_M200 weighted nevt=" << met_Stage1_2prong_WToTauNu_M200->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M200->Integral();
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M500  = (TH1D*)file_WToTauNu_M500->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M500->Scale(wt_WToTauNu_M500);
 std::cout << "WToTauNu_M500 weighted nevt=" << met_Stage1_2prong_WToTauNu_M500->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M500->Integral() ;
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M1000  = (TH1D*)file_WToTauNu_M1000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M1000->Scale(wt_WToTauNu_M1000);
 std::cout << "WToTauNu_M1000 weighted nevt=" << met_Stage1_2prong_WToTauNu_M1000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M1000->Integral();
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M2000  = (TH1D*)file_WToTauNu_M2000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M2000->Scale(wt_WToTauNu_M2000);
 std::cout << "WToTauNu_M2000 weighted nevt=" << met_Stage1_2prong_WToTauNu_M2000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M2000->Integral();
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M3000  = (TH1D*)file_WToTauNu_M3000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M3000->Scale(wt_WToTauNu_M3000);
 std::cout << "WToTauNu_M3000 weighted nevt=" << met_Stage1_2prong_WToTauNu_M3000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M3000->Integral();
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M4000  = (TH1D*)file_WToTauNu_M4000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M4000->Scale(wt_WToTauNu_M4000);
 std::cout << "WToTauNu_M4000 weighted nevt=" << met_Stage1_2prong_WToTauNu_M4000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M4000->Integral();
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M5000  = (TH1D*)file_WToTauNu_M5000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M5000->Scale(wt_WToTauNu_M5000);
 std::cout << "WToTauNu_M5000 weighted nevt=" << met_Stage1_2prong_WToTauNu_M5000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M5000->Integral();
  ...
  TH1D* met_Stage1_2prong_WToTauNu_M6000  = (TH1D*)file_WToTauNu_M6000->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WToTauNu_M6000->Scale(wt_WToTauNu_M6000);
 std::cout << "WToTauNu_M6000 weighted nevt=" << met_Stage1_2prong_WToTauNu_M6000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WToTauNu_M6000->Integral();
  ...
  TH1D* met_Stage1_2prong_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_WJetsToLNu->Scale(wt_WJetsToLNu);
 std::cout << "WJetsToLNu weighted nevt=" << met_Stage1_2prong_WJetsToLNu->Integral() << std::endl;
 totalMC += met_Stage1_2prong_WJetsToLNu->Integral();

  TH1D* total_WJets = (TH1D*)met_Stage1_2prong_WJetsToLNu_HT100To200->Clone();
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu_HT200To400);
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu_HT400To600);
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu_HT600To800);
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu_HT800To1200);
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu_HT1200To2500);
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu_HT2500ToInf);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M100);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M200);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M500);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M1000);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M2000);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M3000);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M4000);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M5000);
  total_WJets->Add(met_Stage1_2prong_WToTauNu_M6000);
  total_WJets->Add(met_Stage1_2prong_WJetsToLNu);
  ...
  TH1D* met_Stage1_2prong_WW  = (TH1D*)file_WW->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_WW->Sumw2(kFALSE);
  //met_Stage1_2prong_WW->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WW->Scale(wt_WW);
 std::cout << "WW weighted nevt=" << met_Stage1_2prong_WW->Integral() << std::endl;
 totalMC +=met_Stage1_2prong_WW->Integral() ;
  ...
  TH1D* met_Stage1_2prong_WZ  = (TH1D*)file_WZ->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_WZ->Sumw2(kFALSE);
  // met_Stage1_2prong_WZ->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_WZ->Scale(wt_WZ);
  met_Stage1_2prong_WZ->Scale(kfact_WZ);
 std::cout << "WZ weighted nevt=" << met_Stage1_2prong_WZ->Integral() << std::endl;
 totalMC +=  met_Stage1_2prong_WZ->Integral();
  ...
  TH1D* met_Stage1_2prong_ZZ  = (TH1D*)file_ZZ->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_ZZ->Sumw2(kFALSE);
  //met_Stage1_2prong_ZZ->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_ZZ->Scale(wt_ZZ);
  met_Stage1_2prong_ZZ->Scale(kfact_ZZ);
 std::cout << "ZZ weighted nevt=" << met_Stage1_2prong_ZZ->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZZ->Integral();

  TH1D* total_diboson = (TH1D*)met_Stage1_2prong_WW->Clone();
  total_diboson->Add(met_Stage1_2prong_WZ);
  total_diboson->Add(met_Stage1_2prong_ZZ);
  ...
  TH1D* met_Stage1_2prong_QCD_HT200to300  = (TH1D*)file_QCD_HT200to300->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_QCD_HT200to300->Sumw2(kFALSE);
  //met_Stage1_2prong_QCD_HT200to300->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT200to300->Scale(wt_QCD_HT200to300);
 std::cout << "QCD_HT200to300 weighted nevt=" << met_Stage1_2prong_QCD_HT200to300->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT200to300->Integral();
  ...
  TH1D* met_Stage1_2prong_QCD_HT300to500  = (TH1D*)file_QCD_HT300to500->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  // met_Stage1_2prong_QCD_HT300to500->Sumw2(kFALSE);
  // met_Stage1_2prong_QCD_HT300to500->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT300to500->Scale(wt_QCD_HT300to500);
 std::cout << "QCD_HT300to500 weighted nevt=" << met_Stage1_2prong_QCD_HT300to500->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT300to500->Integral();
  ...
  TH1D* met_Stage1_2prong_QCD_HT500to700  = (TH1D*)file_QCD_HT500to700->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_QCD_HT500to700->Sumw2(kFALSE);
  //met_Stage1_2prong_QCD_HT500to700->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT500to700->Scale(wt_QCD_HT500to700);
 std::cout << "QCD_HT500to700 weighted nevt=" << met_Stage1_2prong_QCD_HT500to700->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT500to700->Integral();
  ...
  TH1D* met_Stage1_2prong_QCD_HT700to1000  = (TH1D*)file_QCD_HT700to1000->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_QCD_HT700to1000->Sumw2(kFALSE);
  //met_Stage1_2prong_QCD_HT700to1000->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT700to1000->Scale(wt_QCD_HT700to1000);
 std::cout << "QCD_HT700to1000 weighted nevt=" << met_Stage1_2prong_QCD_HT700to1000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT700to1000->Integral();
  ...
  TH1D* met_Stage1_2prong_QCD_HT1000to1500  = (TH1D*)file_QCD_HT1000to1500->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  // met_Stage1_2prong_QCD_HT1000to1500->Sumw2(kFALSE);
  // met_Stage1_2prong_QCD_HT1000to1500->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT1000to1500->Scale(wt_QCD_HT1000to1500);
 std::cout << "QCD_HT1000to1500 weighted nevt=" << met_Stage1_2prong_QCD_HT1000to1500->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT1000to1500->Integral();
  ...
  TH1D* met_Stage1_2prong_QCD_HT1500to2000  = (TH1D*)file_QCD_HT1500to2000->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_QCD_HT1500to2000->Sumw2(kFALSE);
  //met_Stage1_2prong_QCD_HT1500to2000->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT1500to2000->Scale(wt_QCD_HT1500to2000);
 std::cout << "QCD_HT1500to2000 weighted nevt=" << met_Stage1_2prong_QCD_HT1500to2000->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT1500to2000->Integral() ;
  ...
  TH1D* met_Stage1_2prong_QCD_HT2000toInf  = (TH1D*)file_QCD_HT2000toInf->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  //met_Stage1_2prong_QCD_HT2000toInf->Sumw2(kFALSE);
  //met_Stage1_2prong_QCD_HT2000toInf->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_QCD_HT2000toInf->Scale(wt_QCD_HT2000toInf);
 std::cout << "QCD_HT2000toInf weighted nevt=" << met_Stage1_2prong_QCD_HT2000toInf->Integral() << std::endl;
 totalMC += met_Stage1_2prong_QCD_HT2000toInf->Integral();
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT100To200  = (TH1D*)file_ZJetsToNuNu_HT100To200->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ZJetsToNuNu_HT100To200->Scale(wt_ZJetsToNuNu_HT100To200);
  met_Stage1_2prong_ZJetsToNuNu_HT100To200->Scale(kfact_ZJetsToNuNu_HT100To200);
  //std::cout << "\n" << met_Stage1_2prong_ZJetsToNuNu_HT100To200->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT100To200 weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT100To200->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZJetsToNuNu_HT100To200->Integral();
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT200To400  = (TH1D*)file_ZJetsToNuNu_HT200To400->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ZJetsToNuNu_HT200To400->Scale(wt_ZJetsToNuNu_HT200To400);
  met_Stage1_2prong_ZJetsToNuNu_HT200To400->Scale(kfact_ZJetsToNuNu_HT200To400);
  //std::cout << met_Stage1_2prong_ZJetsToNuNu_HT200To400->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT200To400 weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT200To400->Integral() << std::endl;
 totalMC +=  met_Stage1_2prong_ZJetsToNuNu_HT200To400->Integral();
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT400To600  = (TH1D*)file_ZJetsToNuNu_HT400To600->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ZJetsToNuNu_HT400To600->Scale(wt_ZJetsToNuNu_HT400To600);
  met_Stage1_2prong_ZJetsToNuNu_HT400To600->Scale(kfact_ZJetsToNuNu_HT400To600);
  //  std::cout << met_Stage1_2prong_ZJetsToNuNu_HT400To600->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT400To600 weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT400To600->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZJetsToNuNu_HT400To600->Integral();
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT600To800  = (TH1D*)file_ZJetsToNuNu_HT600To800->Get("demo/histoDir/met_Stage1_2prong");
  met_Stage1_2prong_ZJetsToNuNu_HT600To800->Scale(wt_ZJetsToNuNu_HT600To800);
  met_Stage1_2prong_ZJetsToNuNu_HT600To800->Scale(kfact_ZJetsToNuNu_HT600To800);
  //  std::cout << met_Stage1_2prong_ZJetsToNuNu_HT600To800->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT600To800 weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT600To800->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZJetsToNuNu_HT600To800->Integral() ;
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT800To1200  = (TH1D*)file_ZJetsToNuNu_HT800To1200->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  // met_Stage1_2prong_ZJetsToNuNu_HT800To1200->Sumw2(kFALSE);
  //met_Stage1_2prong_ZJetsToNuNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_ZJetsToNuNu_HT800To1200->Scale(wt_ZJetsToNuNu_HT800To1200);
  met_Stage1_2prong_ZJetsToNuNu_HT800To1200->Scale(kfact_ZJetsToNuNu_HT800To1200);
  //std::cout << met_Stage1_2prong_ZJetsToNuNu_HT800To1200->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT800To1200 weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT800To1200->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZJetsToNuNu_HT800To1200->Integral() ;
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT1200To2500  = (TH1D*)file_ZJetsToNuNu_HT1200To2500->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  // met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->Sumw2(kFALSE);
  // met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->Scale(wt_ZJetsToNuNu_HT1200To2500);
  met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->Scale(kfact_ZJetsToNuNu_HT1200To2500);
  //std::cout << met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT1200To2500 weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZJetsToNuNu_HT1200To2500->Integral() ;
  ...
  TH1D* met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf  = (TH1D*)file_ZJetsToNuNu_HT2500ToInf->Get("demo/histoDir/met_Stage1_2prong");
  // Poisson error //
  // met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->Sumw2(kFALSE);
  // met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->Scale(wt_ZJetsToNuNu_HT2500ToInf);
  met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->Scale(kfact_ZJetsToNuNu_HT2500ToInf);
  // std::cout << met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->GetBinError(600) << std::endl;
 std::cout << "ZJetsToNuNu_HT2500ToInf weighted nevt=" << met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->Integral() << std::endl;
 totalMC += met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf->Integral();

  TH1D* total_QCD = (TH1D*)met_Stage1_2prong_QCD_HT200to300->Clone();
  total_QCD->Add(met_Stage1_2prong_QCD_HT300to500);
  total_QCD->Add(met_Stage1_2prong_QCD_HT500to700);
  total_QCD->Add(met_Stage1_2prong_QCD_HT700to1000);
  total_QCD->Add(met_Stage1_2prong_QCD_HT1000to1500);
  total_QCD->Add(met_Stage1_2prong_QCD_HT1500to2000);
  total_QCD->Add(met_Stage1_2prong_QCD_HT2000toInf);

  //  total_QCD->SetFillColorAlpha(kPink+1,0.5);
  ///  total_QCD->SetLineColor(kBlack);
  //  total_QCD->Rebin(40);
 //  TH1D* total_ZJets = (TH1D*)met_Stage1_2prong_ZJetsToNuNu_HT100To200->Clone();
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT100To200);
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT200To400);
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT400To600);
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT600To800);
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT800To1200);
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT1200To2500);
  total_QCD->Add(met_Stage1_2prong_ZJetsToNuNu_HT2500ToInf);
  ...
  //--Data--//
   TH1D* met_Stage1_2prong_Run2016F  =  (TH1D*)file_Tau_Run2016F->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016E  =  (TH1D*)file_Tau_Run2016E->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016D  =  (TH1D*)file_Tau_Run2016D->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016C  =  (TH1D*)file_Tau_Run2016C->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016B  =  (TH1D*)file_Tau_Run2016B->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016G  =  (TH1D*)file_Tau_Run2016G->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016H_v2  = (TH1D*)file_Tau_Run2016H_v2->Get("demo/histoDir/met_Stage1_2prong");
   TH1D* met_Stage1_2prong_Run2016H_v3  = (TH1D*)file_Tau_Run2016H_v3->Get("demo/histoDir/met_Stage1_2prong");
   
   /*
  std::cout << "Will Clone B" << std::endl;
  TH1D* met_Stage1_2prong_Run2016BCD = (TH1D*)met_Stage1_2prong_Run2016B->Clone();
 
  std::cout << "Will add C" << std::endl;
  met_Stage1_2prong_Run2016BCD->Add(met_Stage1_2prong_Run2016C);

  std::cout << "Will add D" << std::endl;
  met_Stage1_2prong_Run2016BCD->Add(met_Stage1_2prong_Run2016D);

  //  std::cout << "Will add E" << std::endl;
  // met_Stage1_2prong_Run2016BCDEF->Add(met_Stage1_2prong_Run2016E);

  // std::cout << "Will add F" << std::endl;
  //  met_Stage1_2prong_Run2016BCDEF->Add(met_Stage1_2prong_Run2016F);
  */

  TH1D* met_Stage1_2prong_Run2016all = (TH1D*)met_Stage1_2prong_Run2016B->Clone();
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016C);
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016D);
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016E);
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016F);
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016G);
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016H_v2);
  met_Stage1_2prong_Run2016all->Add(met_Stage1_2prong_Run2016H_v3);
                                                                                                                                    
  met_Stage1_2prong_Run2016all->SetMarkerStyle(20);
  met_Stage1_2prong_Run2016all->SetMarkerColor(kBlack);
  met_Stage1_2prong_Run2016all->SetLineColor(kBlack);
  met_Stage1_2prong_Run2016all->Rebin(40);
  ...
  TH1D* met_Stage1_2prong_Wprime_M4000  = (TH1D*)file_Wprime_M4000->Get("demo/histoDir/met_Stage1_2prong");
  std::cout << "Sig Eff W' M4000 : " << ( met_Stage1_2prong_Wprime_M4000->GetEntries() / evt_Wprime_M4000 ) << std::endl;
  met_Stage1_2prong_Wprime_M4000->Scale(wt_Wprime_M4000);
  //  met_Stage1_2prong_Wprime_M4000->SetFillColorAlpha(kGreen-7,0.5);
  met_Stage1_2prong_Wprime_M4000->SetLineColor(kMagenta);
  met_Stage1_2prong_Wprime_M4000->SetLineWidth(2);
  met_Stage1_2prong_Wprime_M4000->SetLineStyle(5);
  met_Stage1_2prong_Wprime_M4000->Rebin(40) ;
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("Out_met_Stage1_2prong.root","RECREATE");
  outputFile->cd();

  //--//
  THStack *hs = new THStack("hs","");
  // hs->Add(met_Stage1_2prong_WJetsToLNu);
  hs->Add(total_diboson);
  hs->Add(total_DY);
  hs->Add(total_ST);
  hs->Add(total_TT);
  //  hs->Add(met_Stage1_2prong_DYJetsToLL_M50);
  hs->Add(total_QCD);
  //  hs->Add(total_ZJets);
  hs->Add(total_WJets);
  //met_Stage1_2prong_->SetTitle("");
    /*
  ...
  */
  ...
  //  met_Stage1_2prong_Run2016E->Draw("SAME E0");
  met_Stage1_2prong_Run2016all->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)met_Stage1_2prong_Run2016all->Clone();

  //met_Stage1_2prong_Run2016C->Draw("SAME E0");
  //met_Stage1_2prong_Run2016CDE->Draw("SAME E0");
  //
  met_Stage1_2prong_Wprime_M4000->Draw("SAME HIST");
  //  hs->SetOption("HIST L");
  ...
  //leg_example->AddEntry(met_Stage1_2prong_WJetsToLNu, "Wjets","f");
  ...
  leg_example->AddEntry(met_Stage1_2prong_Wprime_M4000, "SSM W' 4 TeV", "l");
  leg_example->AddEntry(met_Stage1_2prong_Run2016all, "Data", "pl" );
  // leg_example->AddEntry(met_Stage1_2prong_Run2016E, "Data", "pl" );
  // leg_example->AddEntry(met_Stage1_2prong_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("met_Stage1_2prong.pdf");
  ...
  */
  ...
  ratio_c->Write();
  ratio_c->Print("met_Stage1_2prong_ratio.pdf");
