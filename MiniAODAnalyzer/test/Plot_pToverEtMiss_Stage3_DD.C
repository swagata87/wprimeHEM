...
int Plot_pToverEtMiss_Stage3_DD() {
  ...
  TH1D* pToverEtMiss_Stage3_DYJetsToLL_M50 = (TH1D*)file_DYJetsToLL_M50->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_DYJetsToLL_M50->Scale(wt_DYJetsToLL_M50);
  std::cout << "DYJetsToLL_M50 weighted nevt=" << pToverEtMiss_Stage3_DYJetsToLL_M50->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_DYJetsToLL_M50->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_DYJetsToLL_M5to50 = (TH1D*)file_DYJetsToLL_M5to50->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_DYJetsToLL_M5to50->Scale(wt_DYJetsToLL_M5to50);
  std::cout << "DYJetsToLL_M5to50 weighted nevt=" << pToverEtMiss_Stage3_DYJetsToLL_M5to50->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_DYJetsToLL_M5to50->Integral() ;
  //
  TH1D* total_DY = (TH1D*)pToverEtMiss_Stage3_DYJetsToLL_M50->Clone(); 
  total_DY->Add(pToverEtMiss_Stage3_DYJetsToLL_M5to50);
  ...
  TH1D* pToverEtMiss_Stage3_TT  = (TH1D*)file_TT->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_TT->Scale(wt_TT);
  pToverEtMiss_Stage3_TT->Scale(kfact_TT);
  std::cout << "TTbar weighted nevt=" << pToverEtMiss_Stage3_TT->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_TT->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_TT_Mtt_700to1000  = (TH1D*)file_TT_Mtt_700to1000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_TT_Mtt_700to1000->Scale(wt_TT_Mtt_700to1000);
  pToverEtMiss_Stage3_TT_Mtt_700to1000->Scale(kfact_TT_Mtt_700to1000);
  std::cout << "TT_Mtt_700to1000bar weighted nevt=" << pToverEtMiss_Stage3_TT_Mtt_700to1000->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_TT_Mtt_700to1000->Integral() ;
  ...
  TH1D* pToverEtMiss_Stage3_TT_Mtt_1000toInf  = (TH1D*)file_TT_Mtt_1000toInf->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_TT_Mtt_1000toInf->Scale(wt_TT_Mtt_1000toInf);
  pToverEtMiss_Stage3_TT_Mtt_1000toInf->Scale(kfact_TT_Mtt_1000toInf);
  std::cout << "TT_Mtt_1000toInfbar weighted nevt=" << pToverEtMiss_Stage3_TT_Mtt_1000toInf->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_TT_Mtt_1000toInf->Integral() ;

  TH1D* total_TT = (TH1D*)pToverEtMiss_Stage3_TT->Clone(); 
  total_TT->Add(pToverEtMiss_Stage3_TT_Mtt_700to1000);
  total_TT->Add(pToverEtMiss_Stage3_TT_Mtt_1000toInf);
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //
  pToverEtMiss_Stage3_WJetsToLNu->Sumw2(kFALSE);
  pToverEtMiss_Stage3_WJetsToLNu->SetBinErrorOption(TH1::kPoisson);
  std::cout << "**WJets** unweighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu->Integral() << std::endl;
  std::cout << "wt_WJetsToLNu = " << wt_WJetsToLNu << std::endl;
  pToverEtMiss_Stage3_WJetsToLNu->Scale(wt_WJetsToLNu);
  pToverEtMiss_Stage3_WJetsToLNu->SetFillColorAlpha(kGreen-7,0.5);
  pToverEtMiss_Stage3_WJetsToLNu->SetLineColor(kGreen-7);
  pToverEtMiss_Stage3_WJetsToLNu->Rebin(40);
  std::cout << "**WJets** weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu->Integral() << std::endl;
  */
  ...
  TH1D* pToverEtMiss_Stage3_ST_tchannel_antitop  = (TH1D*)file_ST_tchannel_antitop->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_ST_tchannel_antitop->Scale(wt_ST_tchannel_antitop);
  pToverEtMiss_Stage3_ST_tchannel_antitop->Scale(kfact_ST_tchannel_antitop);
  std::cout << "ST_tchannel_antitop weighted nevt=" << pToverEtMiss_Stage3_ST_tchannel_antitop->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_ST_tchannel_antitop->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_ST_tchannel_top  = (TH1D*)file_ST_tchannel_top->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_ST_tchannel_top->Scale(wt_ST_tchannel_top);
  pToverEtMiss_Stage3_ST_tchannel_top->Scale(kfact_ST_tchannel_top);
  std::cout << "ST_tchannel_top weighted nevt=" << pToverEtMiss_Stage3_ST_tchannel_top->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_ST_tchannel_top->Integral() ;
  ...
  TH1D* pToverEtMiss_Stage3_ST_tW_antitop  = (TH1D*)file_ST_tW_antitop->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_ST_tW_antitop->Scale(wt_ST_tW_antitop);
  pToverEtMiss_Stage3_ST_tW_antitop->Scale(kfact_ST_tW_antitop);
  std::cout << "ST_tW_antitop weighted nevt=" << pToverEtMiss_Stage3_ST_tW_antitop->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_ST_tW_antitop->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_ST_tW_top  = (TH1D*)file_ST_tW_top->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_ST_tW_top->Scale(wt_ST_tW_top);
  pToverEtMiss_Stage3_ST_tW_top->Scale(kfact_ST_tW_top);
  std::cout << "ST_tW_top weighted nevt=" << pToverEtMiss_Stage3_ST_tW_top->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_ST_tW_top->Integral() ;

  TH1D* total_ST = (TH1D*)pToverEtMiss_Stage3_ST_tchannel_antitop->Clone(); 
  total_ST->Add(pToverEtMiss_Stage3_ST_tchannel_top);
  total_ST->Add(pToverEtMiss_Stage3_ST_tW_antitop);
  total_ST->Add(pToverEtMiss_Stage3_ST_tW_top);
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT100To200  = (TH1D*)file_WJetsToLNu_HT100To200->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                           
  //  pToverEtMiss_Stage3_WJetsToLNu_HT100To200->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WJetsToLNu_HT100To200->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT100To200->Scale(wt_WJetsToLNu_HT100To200);
  std::cout << "WJetsToLNu_HT100To200 weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT100To200->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_WJetsToLNu_HT100To200->Integral();
  //pToverEtMiss_Stage3_WJetsToLNu_HT100To200->Scale(kfact_WJetsToLNu_HT100To200);
  //  std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT100To200->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT200To400  = (TH1D*)file_WJetsToLNu_HT200To400->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                                                                                                                                                      
  // pToverEtMiss_Stage3_WJetsToLNu_HT200To400->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WJetsToLNu_HT200To400->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT200To400->Scale(wt_WJetsToLNu_HT200To400);
 std::cout << "WJetsToLNu_HT200To400 weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT200To400->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WJetsToLNu_HT200To400->Integral();
  //pToverEtMiss_Stage3_WJetsToLNu_HT200To400->Scale(kfact_WJetsToLNu_HT200To400);
  //std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT200To400->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT400To600  = (TH1D*)file_WJetsToLNu_HT400To600->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                                                                                                                                                      
  // pToverEtMiss_Stage3_WJetsToLNu_HT400To600->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WJetsToLNu_HT400To600->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT400To600->Scale(wt_WJetsToLNu_HT400To600);
  std::cout << "WJetsToLNu_HT400To600 weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT400To600->Integral() << std::endl;
  totalMC += pToverEtMiss_Stage3_WJetsToLNu_HT400To600->Integral();
  // pToverEtMiss_Stage3_WJetsToLNu_HT400To600->Scale(kfact_WJetsToLNu_HT400To600);
  // std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT400To600->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT600To800  = (TH1D*)file_WJetsToLNu_HT600To800->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                                                                                                                                                      
  //  pToverEtMiss_Stage3_WJetsToLNu_HT600To800->Sumw2(kFALSE);
  // pToverEtMiss_Stage3_WJetsToLNu_HT600To800->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT600To800->Scale(wt_WJetsToLNu_HT600To800);
  std::cout << "WJetsToLNu_HT600To800 weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT600To800->Integral() << std::endl;
  totalMC +=  pToverEtMiss_Stage3_WJetsToLNu_HT600To800->Integral();
  // pToverEtMiss_Stage3_WJetsToLNu_HT600To800->Scale(kfact_WJetsToLNu_HT600To800);
  // std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT600To800->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT800To1200  = (TH1D*)file_WJetsToLNu_HT800To1200->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                                                                                                                                                      
  // pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->Scale(wt_WJetsToLNu_HT800To1200);
 std::cout << "WJetsToLNu_HT800To1200 weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->Integral();
  //pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->Scale(kfact_WJetsToLNu_HT800To1200);
  // std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT800To1200->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500  = (TH1D*)file_WJetsToLNu_HT1200To2500->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                                                                                                                                                      
  // pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->Scale(wt_WJetsToLNu_HT1200To2500);
 std::cout << "WJetsToLNu_HT1200To2500 weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->Integral();
  // pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->Scale(kfact_WJetsToLNu_HT1200To2500);
  //std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf  = (TH1D*)file_WJetsToLNu_HT2500ToInf->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //                                                                                                                                                      
  //pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->Scale(wt_WJetsToLNu_HT2500ToInf);
 std::cout << "WJetsToLNu_HT2500ToInf weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->Integral();
  //pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->Scale(kfact_WJetsToLNu_HT2500ToInf);
  ///std::cout << pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf->GetBinError(300) << std::endl;
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M100  = (TH1D*)file_WToTauNu_M100->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M100->Scale(wt_WToTauNu_M100);
 std::cout << "WToTauNu_M100 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M100->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M100->Integral() ;
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M200  = (TH1D*)file_WToTauNu_M200->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M200->Scale(wt_WToTauNu_M200);
 std::cout << "WToTauNu_M200 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M200->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M200->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M500  = (TH1D*)file_WToTauNu_M500->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M500->Scale(wt_WToTauNu_M500);
 std::cout << "WToTauNu_M500 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M500->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M500->Integral() ;
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M1000  = (TH1D*)file_WToTauNu_M1000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M1000->Scale(wt_WToTauNu_M1000);
 std::cout << "WToTauNu_M1000 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M1000->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M1000->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M2000  = (TH1D*)file_WToTauNu_M2000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M2000->Scale(wt_WToTauNu_M2000);
 std::cout << "WToTauNu_M2000 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M2000->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M2000->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M3000  = (TH1D*)file_WToTauNu_M3000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M3000->Scale(wt_WToTauNu_M3000);
 std::cout << "WToTauNu_M3000 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M3000->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M3000->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M4000  = (TH1D*)file_WToTauNu_M4000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M4000->Scale(wt_WToTauNu_M4000);
 std::cout << "WToTauNu_M4000 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M4000->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M4000->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M5000  = (TH1D*)file_WToTauNu_M5000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M5000->Scale(wt_WToTauNu_M5000);
 std::cout << "WToTauNu_M5000 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M5000->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M5000->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WToTauNu_M6000  = (TH1D*)file_WToTauNu_M6000->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WToTauNu_M6000->Scale(wt_WToTauNu_M6000);
 std::cout << "WToTauNu_M6000 weighted nevt=" << pToverEtMiss_Stage3_WToTauNu_M6000->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WToTauNu_M6000->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_WJetsToLNu  = (TH1D*)file_WJetsToLNu->Get("demo/histoDir/pToverEtMiss_Stage3");
  pToverEtMiss_Stage3_WJetsToLNu->Scale(wt_WJetsToLNu);
 std::cout << "WJetsToLNu weighted nevt=" << pToverEtMiss_Stage3_WJetsToLNu->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_WJetsToLNu->Integral();

  TH1D* total_WJets = (TH1D*)pToverEtMiss_Stage3_WJetsToLNu_HT100To200->Clone();
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu_HT200To400);
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu_HT400To600);
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu_HT600To800);
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu_HT800To1200);
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu_HT1200To2500);
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu_HT2500ToInf);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M100);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M200);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M500);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M1000);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M2000);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M3000);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M4000);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M5000);
  total_WJets->Add(pToverEtMiss_Stage3_WToTauNu_M6000);
  total_WJets->Add(pToverEtMiss_Stage3_WJetsToLNu);
  ...
  TH1D* pToverEtMiss_Stage3_WW  = (TH1D*)file_WW->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //
  //pToverEtMiss_Stage3_WW->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_WW->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WW->Scale(wt_WW);
 std::cout << "WW weighted nevt=" << pToverEtMiss_Stage3_WW->Integral() << std::endl;
 totalMC +=pToverEtMiss_Stage3_WW->Integral() ;
  ...
  TH1D* pToverEtMiss_Stage3_WZ  = (TH1D*)file_WZ->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //
  //pToverEtMiss_Stage3_WZ->Sumw2(kFALSE);
  // pToverEtMiss_Stage3_WZ->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_WZ->Scale(wt_WZ);
  pToverEtMiss_Stage3_WZ->Scale(kfact_WZ);
 std::cout << "WZ weighted nevt=" << pToverEtMiss_Stage3_WZ->Integral() << std::endl;
 totalMC +=  pToverEtMiss_Stage3_WZ->Integral();
  ...
  TH1D* pToverEtMiss_Stage3_ZZ  = (TH1D*)file_ZZ->Get("demo/histoDir/pToverEtMiss_Stage3");
  // Poisson error //
  //pToverEtMiss_Stage3_ZZ->Sumw2(kFALSE);
  //pToverEtMiss_Stage3_ZZ->SetBinErrorOption(TH1::kPoisson);
  pToverEtMiss_Stage3_ZZ->Scale(wt_ZZ);
  pToverEtMiss_Stage3_ZZ->Scale(kfact_ZZ);
 std::cout << "ZZ weighted nevt=" << pToverEtMiss_Stage3_ZZ->Integral() << std::endl;
 totalMC += pToverEtMiss_Stage3_ZZ->Integral();

  TH1D* total_diboson = (TH1D*)pToverEtMiss_Stage3_WW->Clone();
  total_diboson->Add(pToverEtMiss_Stage3_WZ);
  total_diboson->Add(pToverEtMiss_Stage3_ZZ);
  ...
  TH1D* total_QCD = (TH1D*)file_Datadriven->Get("demo/histoDir/pToverEtMiss_Stage3");
  ...
  //--Data--//
   TH1D* pToverEtMiss_Stage3_Run2016F  =  (TH1D*)file_Tau_Run2016F->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016E  =  (TH1D*)file_Tau_Run2016E->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016D  =  (TH1D*)file_Tau_Run2016D->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016C  =  (TH1D*)file_Tau_Run2016C->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016B  =  (TH1D*)file_Tau_Run2016B->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016G  =  (TH1D*)file_Tau_Run2016G->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016H_v2  = (TH1D*)file_Tau_Run2016H_v2->Get("demo/histoDir/pToverEtMiss_Stage3");
   TH1D* pToverEtMiss_Stage3_Run2016H_v3  = (TH1D*)file_Tau_Run2016H_v3->Get("demo/histoDir/pToverEtMiss_Stage3");
   
   /*
  std::cout << "Will Clone B" << std::endl;
  TH1D* pToverEtMiss_Stage3_Run2016BCD = (TH1D*)pToverEtMiss_Stage3_Run2016B->Clone();
 
  std::cout << "Will add C" << std::endl;
  pToverEtMiss_Stage3_Run2016BCD->Add(pToverEtMiss_Stage3_Run2016C);

  std::cout << "Will add D" << std::endl;
  pToverEtMiss_Stage3_Run2016BCD->Add(pToverEtMiss_Stage3_Run2016D);

  //  std::cout << "Will add E" << std::endl;
  // pToverEtMiss_Stage3_Run2016BCDEF->Add(pToverEtMiss_Stage3_Run2016E);

  // std::cout << "Will add F" << std::endl;
  //  pToverEtMiss_Stage3_Run2016BCDEF->Add(pToverEtMiss_Stage3_Run2016F);
  */

  TH1D* pToverEtMiss_Stage3_Run2016all = (TH1D*)pToverEtMiss_Stage3_Run2016B->Clone();
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016C);
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016D);
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016E);
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016F);
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016G);
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016H_v2);
  pToverEtMiss_Stage3_Run2016all->Add(pToverEtMiss_Stage3_Run2016H_v3);
                                                                                                                                    
  pToverEtMiss_Stage3_Run2016all->SetMarkerStyle(20);
  pToverEtMiss_Stage3_Run2016all->SetMarkerColor(kBlack);
  pToverEtMiss_Stage3_Run2016all->SetLineColor(kBlack);
  pToverEtMiss_Stage3_Run2016all->Rebin(10);
  ...
  TH1D* pToverEtMiss_Stage3_Wprime_M4000  = (TH1D*)file_Wprime_M4000->Get("demo/histoDir/pToverEtMiss_Stage3");
  std::cout << "Sig Eff W' M4000 : " << ( pToverEtMiss_Stage3_Wprime_M4000->GetEntries() / evt_Wprime_M4000 ) << std::endl;
  pToverEtMiss_Stage3_Wprime_M4000->Scale(wt_Wprime_M4000);
  //  pToverEtMiss_Stage3_Wprime_M4000->SetFillColorAlpha(kGreen-7,0.5);
  pToverEtMiss_Stage3_Wprime_M4000->SetLineColor(kMagenta);
  pToverEtMiss_Stage3_Wprime_M4000->SetLineWidth(4);
  pToverEtMiss_Stage3_Wprime_M4000->SetLineStyle(5);
  pToverEtMiss_Stage3_Wprime_M4000->Rebin(10) ;
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("Out_pToverEtMiss_Stage3.root","RECREATE");
  outputFile->cd();

  //--//
  THStack *hs = new THStack("hs","");
  // hs->Add(pToverEtMiss_Stage3_WJetsToLNu);
  hs->Add(total_diboson);
  hs->Add(total_DY);
  hs->Add(total_ST);
  hs->Add(total_TT);
  //  hs->Add(pToverEtMiss_Stage3_DYJetsToLL_M50);
  hs->Add(total_QCD);
  //  hs->Add(total_ZJets);
  hs->Add(total_WJets);
  //pToverEtMiss_Stage3_->SetTitle("");
    /*
  ...
  */
  ...
  //  pToverEtMiss_Stage3_Run2016E->Draw("SAME E0");
  pToverEtMiss_Stage3_Run2016all->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)pToverEtMiss_Stage3_Run2016all->Clone();

  //pToverEtMiss_Stage3_Run2016C->Draw("SAME E0");
  //pToverEtMiss_Stage3_Run2016CDE->Draw("SAME E0");
  //
  pToverEtMiss_Stage3_Wprime_M4000->Draw("SAME HIST");
  //  hs->SetOption("HIST L");
  ...
  //leg_example->AddEntry(pToverEtMiss_Stage3_WJetsToLNu, "Wjets","f");
  ...
  leg_example->AddEntry(pToverEtMiss_Stage3_Wprime_M4000, "SSM W' 4 TeV", "l");
  leg_example->AddEntry(pToverEtMiss_Stage3_Run2016all, "Data", "pl" );
  // leg_example->AddEntry(pToverEtMiss_Stage3_Run2016E, "Data", "pl" );
  // leg_example->AddEntry(pToverEtMiss_Stage3_Run2016D, "Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("pToverEtMiss_Stage3_DD.pdf");
  ...
  */
  ...
  TLine *l1=new TLine(0.7,0,0.7,10000);
  l1->SetLineColor(12);
  l1->SetLineWidth(4);
  l1->SetLineStyle(2);
  l1->Draw("same");

  TLine *l2=new TLine(1.3,0,1.3,10000);
  l2->SetLineColor(12);
  l2->SetLineWidth(4);
  l2->SetLineStyle(2);
  l2->Draw("same");
  ...
  TH1F *data_by_MC = new TH1F("h1", "ratio", nbin, 0, 3);
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("pT/MET");
  ...
  data_by_MC->SetTitle("");
  data_by_MC->GetXaxis()->SetRangeUser(0, 3);
  ...
  ratio_c->Write();
  ratio_c->Print("pToverEtMiss_Stage3_ratio_DD.pdf");
