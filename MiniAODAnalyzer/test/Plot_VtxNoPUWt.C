...
int Plot_VtxNoPUWt() {
 ...
 std::cout << "ZJetsToNuNu_HT2500ToInf weighted nevt=" << recoVtx_NoPUWt_ZJetsToNuNu_HT2500ToInf->Integral() << std::endl;
  ...
  // recoVtx_NoPUWt_Run2016E->Rebin(40);
  //
   ...
   // recoVtx_NoPUWt_Run2016D->Rebin(40);
  //
   ...
   //  recoVtx_NoPUWt_Run2016C->Rebin(40);

      TH1D* recoVtx_NoPUWt_Run2016B  = (TH1D*)file_Tau_Run2016B->Get("demo/histoDir/recoVtx_NoPUWt");
   // recoVtx_NoPUWt_Run2016B->SetMarkerStyle(20);
   // recoVtx_NoPUWt_Run2016B->SetMarkerColor(kBlack);
   //  recoVtx_NoPUWt_Run2016B->SetLineColor(kBlack);
   //  recoVtx_NoPUWt_Run2016B->Rebin(40);

   //TH1D* recoVtx_NoPUWt_Run2016G  = (TH1D*)file_Tau_Run2016G->Get("demo/histoDir/recoVtx_NoPUWt");
      // TH1D* recoVtx_NoPUWt_Run2016H  = (TH1D*)file_Tau_Run2016H->Get("demo/histoDir/recoVtx_NoPUWt");
  ...
  */
  ...
  TH1D* recoVtx_NoPUWt_Run2016BCDEF = (TH1D*)recoVtx_NoPUWt_Run2016B->Clone();
  recoVtx_NoPUWt_Run2016BCDEF->Add(recoVtx_NoPUWt_Run2016C);
  recoVtx_NoPUWt_Run2016BCDEF->Add(recoVtx_NoPUWt_Run2016D);
  recoVtx_NoPUWt_Run2016BCDEF->Add(recoVtx_NoPUWt_Run2016E);
  recoVtx_NoPUWt_Run2016BCDEF->Add(recoVtx_NoPUWt_Run2016F);
                                                                                                                                    
  recoVtx_NoPUWt_Run2016BCDEF->SetMarkerStyle(20);
  recoVtx_NoPUWt_Run2016BCDEF->SetMarkerColor(kBlack);
  recoVtx_NoPUWt_Run2016BCDEF->SetLineColor(kBlack);
  // recoVtx_NoPUWt_Run2016GH->Rebin(40);
  ...
  //  recoVtx_NoPUWt_Wprime_M1000->SetFillColorAlpha(kGreen-7,0.5);
  ...
  //  recoVtx_NoPUWt_Wprime_M1000->Rebin(40);
  ...
  */
  ...
  recoVtx_NoPUWt_Run2016BCDEF->Draw("SAME E0");
  TH1F* mydata =  (TH1F*)recoVtx_NoPUWt_Run2016BCDEF->Clone();
  ...
  leg_example->AddEntry(recoVtx_NoPUWt_Run2016BCDEF, "Data", "pl" );
  ...
  */
  ...
  data_by_MC->Draw("E");
  data_by_MC->GetXaxis()->SetTitle("nVtx [w/o PU wt]");
