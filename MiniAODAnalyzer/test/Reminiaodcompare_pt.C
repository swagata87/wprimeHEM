...
int Reminiaodcompare_pt() {
  ...
  //--Data--//
   TH1D* tauPt_Stage1_Run2016F_old  =  (TH1D*)file_Tau_Run2016F_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016E_old  =  (TH1D*)file_Tau_Run2016E_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016D_old  =  (TH1D*)file_Tau_Run2016D_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016C_old  =  (TH1D*)file_Tau_Run2016C_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016B_old  =  (TH1D*)file_Tau_Run2016B_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016G_old  =  (TH1D*)file_Tau_Run2016G_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016H_v2_old  = (TH1D*)file_Tau_Run2016H_v2_old->Get("demo/histoDir/tauPt_Stage1");
   TH1D* tauPt_Stage1_Run2016H_v3_old  = (TH1D*)file_Tau_Run2016H_v3_old->Get("demo/histoDir/tauPt_Stage1");
   

  TH1D* tauPt_Stage1_Run2016all_old = (TH1D*)tauPt_Stage1_Run2016B_old->Clone();
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016C_old);
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016D_old);
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016E_old);
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016F_old);
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016G_old);
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016H_v2_old);
  tauPt_Stage1_Run2016all_old->Add(tauPt_Stage1_Run2016H_v3_old);
                                                                                                                                    
  tauPt_Stage1_Run2016all_old->SetMarkerStyle(24);
  tauPt_Stage1_Run2016all_old->SetMarkerColor(kBlue);
  tauPt_Stage1_Run2016all_old->SetLineColor(kBlue);
  tauPt_Stage1_Run2016all_old->Rebin(10);
  ...
  tauPt_Stage1_Run2016all->Draw("E0");
  tauPt_Stage1_Run2016all_old->Draw("SAME E0");

  tauPt_Stage1_Run2016all->SetMaximum(100000);
  tauPt_Stage1_Run2016all->SetMinimum(0.1);
  tauPt_Stage1_Run2016all->GetXaxis()->SetRangeUser(0, 1000);
  tauPt_Stage1_Run2016all->GetXaxis()->SetTitle("#tau pT [GeV]"); 
  tauPt_Stage1_Run2016all->GetYaxis()->SetTitle("Events");

  TH1F* mydata =  (TH1F*)tauPt_Stage1_Run2016all->Clone();
  TH1F* mydata_old =  (TH1F*)tauPt_Stage1_Run2016all_old->Clone();
  ...
  leg_example->AddEntry(tauPt_Stage1_Run2016all, "Re-MiniAOD Data", "pl" );
  leg_example->AddEntry(tauPt_Stage1_Run2016all_old, "Old Data", "pl" );
  leg_example->Draw("same");
  
  my_canvas->Write();
  my_canvas->Print("reminiaod_compare_tauPt.pdf");
  ...
  ratio_c->Write();
  ratio_c->Print("reminiaod_compare_tauPt_ratio.pdf");
